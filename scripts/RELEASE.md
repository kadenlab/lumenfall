...
配布物：`lumenfall-chapter3.zip`。Chapter 1・2・3、灯の試練5種、アクセサリー2枠、既存セーブ互換、最新docs/を収録。展開した中身をリポジトリ直下へ上書きし、Pagesのmain /docs設定を維持する。セーブ削除不要。個別のCNAMEなど既存の独自設定は保持する。

詳細：[Chapter 3](CHAPTER3.md)、[検証記録](CHAPTER3-QA.md)。以下は過去リリースの履歴です。
