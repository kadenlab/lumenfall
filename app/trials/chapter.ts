...
const pack:Chapter={id:'trials',title:'灯の試練',unlockNext:[],start:{area:0,x:0,z:7},returnTo:{area:0,x:0,z:7},respawn:{area:0,x:0,z:7},
 ...
 paintSprite(kind,r){if(!kind.startsWith('trial-'))return false;const boss=kind==='trial-5',color=boss?'#887cbb':'#668eae';r(17,10,14,10,'#bceafa');r(12,22,24,25,color);r(6,27,8,22,'#304558');r(34,25,8,25,'#304558');r(15,45,7,15,'#263545');r(27,45,7,15,'#263545');r(20,17,3,3,'#70fff1');r(27,17,3,3,'#70fff1');r(20,29,10,9,'#a8fff4');if(boss){r(5,5,5,28,'#bcb9d4');r(38,5,5,28,'#bcb9d4');r(9,3,30,4,'#8090ac');r(21,31,8,6,'#132336')}return true},
};export default pack;
