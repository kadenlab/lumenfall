...
`)}var uc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function dc(e,t){let n=uc[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var fc=new J;function pc(){return X.getLuminanceCoefficients(fc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${fc.x.toFixed(4)}, ${fc.y.toFixed(4)}, ${fc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Ll=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Rl=new Pa(-1,1,1,-1,0,1),zl=new class extends Cr{constructor(){super(),this.setAttribute(`position`,new dr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new dr([0,2,0,0,2,0],2))}},Bl=class{constructor(e){this._mesh=new di(zl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Rl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Vl=class extends Ll{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Zi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ji.clone(e.uniforms),this.material=new Zi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Bl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Hl=class extends Ll{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Ul=class extends Ll{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Wl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new q);this._width=n.width,this._height=n.height,t=new Ht(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Vl(Il),this.copyPass.material.blending=0,this.timer=new Va}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Hl!==void 0&&(r instanceof Hl?n=!0:r instanceof Ul&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new q);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Gl=class extends Ll{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Kl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`};var Yl=()=>({area:0,x:0,z:8,hp:100,mp:30,lv:1,xp:0,gold:35,potions:4,ethers:2,sword:!1,armor:!1,quest:0,chests:[],wins:[],seals:[],springUsed:!1,dungeonVersion:1,time:0}),Xl=[[`水灯の町 リュネ`,`LYUNE · THE LANTERN VILLAGE`,`夕映えの水路`],[`琥珀の丘`,`AMBER HIGHLANDS`,`風渡る旧街道`],[`星眠りの遺跡`,`MOONFALL SANCTUM`,`森に眠る双灯の迷宮`]];function Zl(){let e=document.getElementById(`world`),t=document.getElementById(`ui`),n=document.getElementById(`fade`),i,a=!1;try{i=new Cl({canvas:e,antialias:!1,powerPreference:`high-performance`})}catch{a=!0;let t=e.cloneNode();e.replaceWith(t),e=t,i=new Al(e)}let o=matchMedia(`(pointer:coarse)`).matches,s=new Dl,c=`auto`;try{c=localStorage.getItem(`lumenfall-quality`)||`auto`}catch{}let l={value:0},u=[];i.setPixelRatio(a?1:El(innerWidth,innerHeight,devicePixelRatio,o)),i.shadowMap.enabled=!0,i.shadowMap.autoUpdate=!1,i.shadowMap.type=2,i.toneMapping=4,i.toneMappingExposure=1.18;let d=new kn,f=new ja(36,1,.1,180);d.background=new Z(`#758c98`),d.fog=new On(`#8d9b9b`,.021);let p=a?{addPass:()=>{},setSize:()=>{},dispose:()=>{},render:()=>i.render(d,f)}:new Wl(i);p.addPass(new Gl(d,f));let m=new ql(new q(800,600),.65,.5,.82);p.addPass(m);let h=new Vl({uniforms:{tDiffuse:{value:null},resolution:{value:new q(800,600)},strength:{value:1.7}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`uniform sampler2D tDiffuse;uniform vec2 resolution;uniform float strength;varying vec2 vUv;void main(){float f=smoothstep(.13,.47,abs(vUv.y-.49));vec2 d=vec2(1.)/resolution*f*strength*2.;vec4 c=texture2D(tDiffuse,vUv)*.24;c+=texture2D(tDiffuse,vUv+d)*.12;c+=texture2D(tDiffuse,vUv-d)*.12;c+=texture2D(tDiffuse,vUv+vec2(d.x,-d.y))*.12;c+=texture2D(tDiffuse,vUv+vec2(-d.x,d.y))*.12;c+=texture2D(tDiffuse,vUv+vec2(0.,d.y*2.))*.07;c+=texture2D(tDiffuse,vUv-vec2(0.,d.y*2.))*.07;c+=texture2D(tDiffuse,vUv+vec2(d.x*2.,0.))*.07;c+=texture2D(tDiffuse,vUv-vec2(d.x*2.,0.))*.07;float vig=1.-.32*pow(length((vUv-.5)*1.4),1.5);gl_FragColor=vec4(c.rgb*vig,1.);}`});p.addPass(h);let g=new ya(`#c3e1ef`,`#384538`,2);d.add(g);let _=new Ia(`#ffcf85`,4);_.position.set(-14,25,9),_.castShadow=!0,_.shadow.mapSize.set(1024,1024),Object.assign(_.shadow.camera,{left:-30,right:30,top:30,bottom:-30,near:1,far:90}),_.shadow.bias=-7e-4,_.shadow.normalBias=.035,d.add(_);let v=new Na(`#85dbff`,0,35,1);v.position.set(0,5,0),d.add(v);let y=new bn;d.add(y);let b,x,S,C=[],w=[],T=[],E=[],D=[],ee,O=`title`,k=``,te=[],A=``,j,ne,M=Yl(),N=new Set,re={x:0,y:0},ie=null,ae=[],oe,P=0,se=performance.now(),ce=0,F=!1,le=``,ue=0,de=0,fe=0,I=null,pe=!1,me=``,he=[],ge,_e=!1,ve=0,ye=new J,be=new J,xe=0,Se=new J,Ce=new J,we=0,Te=-1,Ee=-1,De=-1,Oe=0,ke=0,Ae=0,je=0,L=``,Me=!1,Ne=new Set,Pe=new Set,R=new Set,Fe=[],z=Array.from({length:o?4:6},()=>{let e=new Na(`#ffd087`,0,8,2);return d.add(e),e}),B=new Set,Le=(e,t)=>{let n=setTimeout(()=>{B.delete(n),F||e()},t);B.add(n)},Re=()=>100+(M.lv-1)*24,ze=()=>30+(M.lv-1)*8,Be=e=>{let t=Math.sin(e*127.1+311.7)*43758.5453;return t-Math.floor(t)},Ve=(e,t=.9)=>new $i({color:e,roughness:t}),V={stone:Ve(`#8b9186`),dark:Ve(`#505d58`),wall:Ve(`#ddcba6`),wood:Ve(`#665044`),roof:Ve(`#487573`),gold:Ve(`#b38a45`),ground:Ve(`#647b46`),path:Ve(`#b4a17a`)};function H(e,t,n,r,i,o,s,c=!0){let l=new di(new Fi(r,i,o,a?Math.ceil(r/3):1,1,a?Math.ceil(o/3):1),s);return l.position.set(e,t,n),l.castShadow=c,l.receiveShadow=!0,y.add(l),l}function He(e,t,n,r,i,a,o=8){let s=new di(new Li(r,r*1.08,i,o),a);return s.position.set(e,t,n),s.castShadow=!0,s.receiveShadow=!0,y.add(s),s}function Ue(e){let t=document.createElement(`canvas`);t.width=48,t.height=64;let n=t.getContext(`2d`),i=(e,t,r,i,a)=>{n.fillStyle=a,n.fillRect(e,t,r,i)};if(e===`slime`){for(let e=19;e<53;e++){let t=Math.floor(Math.sqrt(Math.max(0,1-((e-37)/19)**2))*20);i(24-t,e,t*2,1,e<28?`#b3ece0`:e<40?`#61c4b0`:`#328b8d`)}i(12,26,9,5,`#dcffec`),i(15,37,4,6,`#173e48`),i(31,37,4,6,`#173e48`),i(22,47,8,2,`#244f56`)}else if(e===`wolf`)i(6,29,35,18,`#4c6280`),i(7,24,19,20,`#768eaa`),i(8,15,6,14,`#91a3b4`),i(22,18,5,12,`#617491`),i(4,34,8,8,`#9aa8b7`),i(9,48,6,10,`#3d4e69`),i(31,46,6,12,`#3d4e69`),i(13,31,4,3,`#f2c16d`),i(38,22,5,19,`#627c98`);else if(e===`boss`){for(let e=6;e<61;e++){let t=Math.floor(12+8*Math.sin(e*.11));i(24-t,e,t*2,1,e<20?`#819daf`:e<44?`#425d73`:`#293a54`)}i(9,1,5,16,`#d1bd82`),i(34,1,5,16,`#d1bd82`),i(5,23,8,19,`#789495`),i(35,23,8,19,`#789495`),i(14,22,7,3,`#fff5a9`),i(28,22,7,3,`#fff5a9`),i(21,32,7,13,`#7dedec`),i(23,34,3,9,`#e1ffff`),i(7,45,8,14,`#334454`),i(33,45,8,14,`#334454`)}else{let t=e!==`hero`,n=e===`mage`,r=n?`#d6d4dc`:t?`#89977a`:`#355f83`;i(17,8,15,6,t?`#aaa197`:`#4a3535`),i(14,13,20,13,t?`#cec1a1`:`#533b36`),i(18,15,14,14,`#e9b58c`),i(29,18,3,3,`#26313b`),i(14,13,7,11,t?`#a7a8a7`:`#684335`),i(16,29,17,20,r),i(12,30,5,16,r),i(32,31,5,13,r),i(13,44,5,5,`#e9b58c`),i(33,42,4,6,`#e9b58c`),i(17,46,7,11,`#283947`),i(27,46,6,11,`#283947`),i(15,56,9,4,`#302d31`),i(27,55,9,4,`#302d31`),i(17,28,18,5,n?`#6bb9b4`:`#dfa552`),i(10,32,6,20,n?`#9eafb9`:`#bd6d49`),i(19,43,14,3,`#97754a`),t||(i(36,25,3,30,`#c1d5d3`),i(33,45,9,3,`#c3a26d`)),n&&(i(9,2,26,6,`#c5c5d9`),i(17,0,13,5,`#b2b5ce`),i(37,24,2,34,`#82775d`),i(34,21,8,7,`#96f7ed`))}let a=new ji(t);return a.magFilter=r,a.minFilter=r,a.colorSpace=Ie,a}let We=new Map;function Ge(e,t,n,r=2.2){We.has(e)||We.set(e,Ue(e));let i=new Ur(new kr({map:We.get(e),color:`#fff4df`,alphaTest:.1,depthWrite:!0}));i.scale.set(r*.75,r,1),i.center.set(.5,0),i.position.set(t,Ke(t,n)+.06,n),y.add(i);let a=new di(new Ii(r*.24,24),new $r({color:`#071a20`,transparent:!0,opacity:.3,depthWrite:!1}));return a.userData.dynamic=!0,a.rotation.x=-Math.PI/2,a.position.set(t,Ke(t,n)+.025,n),y.add(a),i.userData.shadow=a,i}function Ke(e,t){return M.area===1&&e>5?Math.min(2.3,(e-5)*.2):M.area===2&&t<-7?Math.min(1.5,(-t-7)*.22):0}function qe(e,t,n,r=`#ffd087`,i=8){Fe.push({position:new J(e,t,n),color:new Z(r),power:i})}function U(e,t){let n=Ke(e,t);He(e,n+.8,t,.09,1.6,V.wood);let r=document.createElement(`canvas`);r.width=r.height=32;let i=r.getContext(`2d`),a=i.createRadialGradient(16,16,0,16,16,16);a.addColorStop(0,`#fff5c6`),a.addColorStop(.23,`#ffc65b`),a.addColorStop(.5,`#ee761aaa`),a.addColorStop(1,`#ff660000`),i.fillStyle=a,i.fillRect(0,0,32,32);let o=new Ur(new kr({map:new ji(r),blending:2,depthWrite:!1}));o.position.set(e,n+1.8,t),o.scale.set(.7,1.2,1),y.add(o),E.push(o),qe(e,n+2,t)}function W(e,t,n=1){let r=Ke(e,t);He(e,r+1.6*n,t,.23*n,3.2*n,V.wood);for(let i=0;i<3;i++){let a=Ve(M.area===2?[`#234b46`,`#2c6255`,`#427b61`][i]:[`#466c49`,`#648347`,`#839455`][i]),o=new di(new Ri((2-i*.4)*n,2.5*n,7),a);o.position.set(e,r+(3+i*1.1)*n,t),o.rotation.y=Be(e+t)*5,o.castShadow=!0,o.receiveShadow=!0,y.add(o)}w.push({x:e,z:t,w:.6*n,d:.6*n})}function Je(e,t,n){let r=Ke(e,t);for(let n of[-1,1]){He(e+n*2,r+1.7,t,.07,3.4,V.wood);let i=H(e+n*2.3,r+2.65,t,.55,1.1,.05,new $i({color:`#c9a257`,emissive:`#775125`,emissiveIntensity:.3}));i.rotation.z=n*.07,U(e+n*2,t+1)}let i=document.createElement(`canvas`);i.width=512,i.height=100;let a=i.getContext(`2d`);a.fillStyle=`#0d2631e8`,a.fillRect(0,0,512,100),a.strokeStyle=`#e6c47c`,a.lineWidth=4,a.strokeRect(3,3,506,94),a.fillStyle=`#ffe6a8`,a.font=`32px serif`,a.textAlign=`center`,a.fillText(n,256,62);let o=new Ur(new kr({map:new ji(i),depthWrite:!1}));o.position.set(e,r+3.8,t),o.scale.set(6.2,1.21,1),y.add(o);let s=new di(new Hi(1,.045,8,48),new $i({color:`#ffe1a1`,emissive:`#ffc45c`,emissiveIntensity:1.8}));s.rotation.x=-Math.PI/2,s.position.set(e,r+.12,t),y.add(s)}function Ye(){if(M.quest===0||M.quest===3)return;if(M.area===0)return C.find(e=>e.id===`field`);if(M.area===1)return C.find(e=>e.id===`forest`);let e=Nl.find(e=>!M.seals.includes(e.id));return e?C.find(t=>t.id===(M.wins.includes(e.guardian)?e.id:e.guardian)):C.find(e=>e.id===(M.springUsed?`boss`:`spring`))}function Xe(e,t,n,r,i=`#467471`){H(e,1.5,t,n,3,r,V.wall),H(e,.22,t,n+.25,.45,r+.25,V.stone);for(let i of[-n/2+.1,n/2-.1])H(e+i,1.6,t+r/2+.03,.17,2.8,.15,V.wood);H(e,2.7,t+r/2+.05,n,.16,.13,V.wood);let a=Ve(i);for(let i of[-1,1]){let o=H(e+i*n*.25,3.6,t,n*.65,.23,r+.8,a);o.rotation.z=i*-.58;for(let a=0;a<5;a++){let o=H(e+i*(a+.5)*n/10,4.32-a*.18,t,.07,.08,r+.85,V.dark);o.rotation.z=i*-.58}}H(e+.6,4,t-.5,.55,1.8,.65,V.stone),H(e,1,t+r/2+.07,.85,2,.1,V.wood);for(let i of[-n*.3,n*.3])H(e+i,1.65,t+r/2+.09,.7,.9,.07,new $i({color:`#ffce81`,emissive:`#ffac45`,emissiveIntensity:2.2})),H(e+i,1.65,t+r/2+.15,.06,1,.07,V.wood),H(e+i,1.65,t+r/2+.15,.8,.06,.07,V.wood),qe(e+i,1.8,t+r/2+.5,`#ffd291`,4);w.push({x:e,z:t,w:n+.3,d:r+.3})}function Ze(e,t,n,r,i=e){let a={kind:e,name:t,x:n,z:r,r:2.3,id:i};return C.push(a),a}function Qe(e,t,n){let r=Ke(e,t),i=M.chests.includes(n),a=H(e,r+.35,t,.8,.6,.65,i?V.dark:V.wood);H(e,r+.63,t,.87,.13,.69,V.gold),H(e,r+.4,t+.34,.15,.25,.04,V.gold);let o=Ze(`chest`,i?`空の宝箱`:`宝箱を開ける`,e,t,n);o.mesh=a}function $e(e,t,n,r,i=-.22){if(!a){let a=new Jl(new Vi(n,r),{textureWidth:n>3?384:128,textureHeight:n>3?384:128,multisample:0,color:6589073,clipBias:.003});a.rotation.x=-Math.PI/2,a.position.set(e,i,t);let o=a.onBeforeRender,s=-100;a.onBeforeRender=function(...e){if(e[2]!==f||P-s<(O===`battle`?.1:1/15))return;s=P;let t=u.map(e=>e.visible);u.forEach(e=>{e!==a&&(e.visible=!1)});try{o.apply(a,e)}finally{u.forEach((e,n)=>e.visible=t[n])}},y.add(a),u.push(a)}let o=new $i({color:`#4e969c`,transparent:!0,opacity:a?.7:.38,metalness:.7,roughness:.24});o.onBeforeCompile=e=>{e.uniforms.uTime=l,e.vertexShader=`uniform float uTime;
...
transformed.z+=sin(position.x*3.+uTime*1.6+position.y)*.025;`)};let s=new di(new Vi(n,r,a?1:12,a?1:32),o);s.rotation.x=-Math.PI/2,s.position.set(e,i+.06,t),s.userData.dynamic=!0,y.add(s),T.push(s)}function et(){y.traverse(e=>{if(e instanceof di||e instanceof Oi||e instanceof Ur){`geometry`in e&&Ne.add(e.geometry);let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t){Object.values(V).includes(e)||Pe.add(e);let t=e.map;t&&![...We.values()].includes(t)&&R.add(t)}}})}function tt(){u.forEach(e=>e.dispose()),Ne.forEach(e=>e.dispose()),Pe.forEach(e=>e.dispose()),R.forEach(e=>e.dispose()),Ne.clear(),Pe.clear(),R.clear(),d.remove(y),y=new bn,d.add(y),C=[],w=[],T=[],E=[],D=[],he=[],u=[],Fe.length=0}function nt(){et(),tt(),Te=Ee=-100;let e=M.area===2;d.background=new Z(e?`#253e4d`:M.area===1?`#8fa7ac`:`#9ba9a3`),d.fog=new On(e?`#395b64`:M.area===1?`#9caeb0`:`#a0aaa3`,e?.025:.022),g.intensity=e?1.85:1.7,g.groundColor.set(e?`#63777e`:`#384538`),_.color.set(e?`#8dcde5`:`#ffcd88`),_.intensity=e?2.5:3.5,d.userData.fillLift=e?1.16:1;let t=M.area===0?-6:M.area===1?-11:21,n=M.area===0?3.3:M.area===1?5:4,r=t-n/2,s=t+n/2;if(H((-24+r)/2,-1.1,0,r+24,2,48,e?Ve(`#294942`):V.ground),H((s+24)/2,-1.1,0,24-s,2,48,e?Ve(`#294942`):V.ground),H(0,-2.8,0,49,2.1,49,V.dark),M.area===0){$e(-6,0,3.3,47);for(let e of[-8,-4])H(e,.05,0,.4,.4,47,V.stone);for(let e of[5,-8]){H(-6,.1,e,5,.28,3,V.wood);for(let t=0;t<10;t++)H(-8.3+t*.5,.27,e,.07,.04,3,V.gold);for(let t of[-1.45,1.45]){H(-6,.85,e+t,4.8,.12,.13,V.wood);for(let n of[-8,-6,-4])H(n,.5,e+t,.13,1,.13,V.wood)}}w.push({x:-6,z:-17,w:3.5,d:15},{x:-6,z:-1.5,w:3.5,d:9.8},{x:-6,z:15.5,w:3.5,d:17}),H(1,.012,3,6,.04,30,V.path),H(0,.015,4,26,.04,3,V.path),Xe(-13,-2,5.5,4.7,`#405f72`),Xe(7,-4,5.8,5,`#647d6e`),Xe(13,6,4.5,4,`#806552`),Xe(-13,11,5,4,`#426e74`),Xe(6,-16,5.5,4,`#58746a`),He(0,.25,-5,2.2,.5,V.stone,16),He(0,.6,-5,1.6,.45,V.dark,16),$e(0,-5,2.4,2.4,.84),He(0,1.6,-5,.25,2.5,V.stone);let e=new di(new Bi(.5),new $i({color:`#ffe1a1`,emissive:`#ffb95e`,emissiveIntensity:2}));e.position.set(0,3,-5),y.add(e),qe(0,3,-5,`#ffcf89`,12),w.push({x:0,z:-5,w:3.8,d:3.8}),Ge(`npc`,1,1),Ze(`elder`,`灯守のエダ`,1,1),Ge(`npc`,7,0),Ze(`shop`,`道具と装備の店`,7,0),Ge(`mage`,-12,2),Ze(`inn`,`宿屋「水鳥亭」`,-12,2),Qe(12,10,`town`),Ze(`exit`,`琥珀の丘へ`,1,-20,`field`),Je(1,-20,`北門 → 琥珀の丘`),H(1,.015,-16,3.2,.06,10,V.path),U(-3,6),U(3,-10),U(-9,5),U(10,3);for(let e=0;e<22;e++){let t=Be(e+4)*43-21,n=Be(e+98)*43-21;(Math.abs(t)>16||n>16)&&W(t,n,.8+Be(e)*.35)}}else if(M.area===1){$e(-11,0,5,47),w.push({x:-11,z:0,w:5,d:48});for(let e=0;e<20;e++)H(6+e*.65,-.45+e*.065,0,.7,.7+e*.13,46,V.ground);for(let e=0;e<45;e++){let t=22-e;H(Math.sin(t*.13)*2,.035,t,3.3,.06,1.1,V.path)}for(let e=0;e<38;e++){let t=Be(e+44)*42-21,n=Be(e+83)*44-22;Math.abs(t)>6&&Math.abs(t+11)>3&&W(t,n,.65+Be(e)*.7)}for(let e=0;e<12;e++){let t=10+Be(e)*10,n=Be(e+99)*30-15;H(t,Ke(t,n)+.5,n,1.5,1.4,1.6,V.stone).rotation.y=e}Qe(6,5,`field`),Ge(`mage`,3,13),Ze(`traveler`,`旅の薬師`,3,13);let e=Ge(`slime`,0,5,2);M.wins.includes(`slime`)?e.visible=!1:Ze(`enemy`,`露玉プルム`,0,5,`slime`).mesh=e;let t=Ge(`wolf`,-1,-7,2.3);M.wins.includes(`wolf`)?t.visible=!1:Ze(`enemy`,`灰羽の獣`,-1,-7,`wolf`).mesh=t,Ze(`exit`,`リュネの町へ`,0,21,`town`),Ze(`exit`,`星眠りの遺跡へ`,0,-21,`forest`),Je(0,-21,`星眠りの遺跡 →`),U(-2,-18),U(2,-18)}else{$e(21,0,4,47),w.push({x:21,z:0,w:4,d:48});let e=Ve(`#526561`),t=Ve(`#4e6463`),n=Ve(`#81918a`);H(0,-.02,5,33,.12,31,e);for(let e=0;e<19;e++){let t=-7-e*.7;H(0,e*.7*.11-.13,t,32,.25,1,V.stone)}for(let e of jl){let r=Ke(e.x,e.z);H(e.x,r+.7,e.z,e.w,1.4,e.d,t),H(e.x,r+1.46,e.z,e.w+.12,.12,e.d+.12,n),w.push(e);let i=Math.max(e.w,e.d);for(let t=0;t<Math.floor(i/2.5);t++){let n=-i/2+(t+.5)*2.5;H(e.x+(e.w>e.d?n:0),r+.65,e.z+(e.d>e.w?n:0),e.w>e.d?.08:e.w+.03,1.2,e.d>e.w?.08:e.d+.03,V.dark)}}for(let e=0;e<12;e++)H(0,.06,18-e*2,2.4,.09,1.4,V.dark);for(let e of[-10,10])for(let t=0;t<9;t++)H(e,.07,15-t*2,1.8,.08,1.3,V.stone);for(let e=0;e<24;e++)W((e%2?-1:1)*(18.5+Be(e)*1.2),Be(e+77)*42-21,.8+Be(e)*.4);for(let e of[-3,3])He(e,2.2,-8,.5,4.4,V.stone),H(e,4.5,-8,1.4,.35,1.4,n),U(e,13);H(0,4.5,-8,7,.45,1.2,n);let r=Pl(M.seals,M.quest);if(!r){w.push(Ml);for(let e=-2;e<=2;e++)H(e,2.05,-8,.18,3.3,.2,new $i({color:`#addaf1`,emissive:`#539ddc`,emissiveIntensity:1.2}));H(0,1.8,-8,5.5,3.4,.12,new $i({color:`#6b9fc6`,emissive:`#3e82ad`,emissiveIntensity:.4,transparent:!0,opacity:.28})),qe(0,3,-7,`#8dcaff`,15)}Ze(`gate`,r?`開かれた双灯の扉`:`双灯の扉（封印 ${M.seals.length}/2）`,0,-5.7,`gate`);for(let e of Nl){let t=M.seals.includes(e.id);He(e.x,.35,e.z,1.45,.7,V.stone,12);let n=new di(new Hi(1.15,.065,8,48),new $i({color:t?`#abffe1`:e.color,emissive:t?`#6cffc2`:e.color,emissiveIntensity:t?2:.7}));n.rotation.x=-Math.PI/2,n.position.set(e.x,.73,e.z),y.add(n);let r=new di(new Bi(.5),new $i({color:e.color,emissive:e.color,emissiveIntensity:t?2.5:.6}));if(r.position.set(e.x,1.65,e.z),y.add(r),qe(e.x,2,e.z,e.color,t?14:5),Ze(`seal`,e.name+(t?`（解放済み）`:``),e.x,e.z,e.id),!M.wins.includes(e.guardian)){let t=Ge(`wolf`,e.gx,e.gz,2.6);t.material.color.set(e.color),Ze(`enemy`,e.enemy,e.gx,e.gz,e.guardian).mesh=t}U(e.x,6)}H(2,.8,16,1.3,1.5,.4,V.stone),Ze(`tablet`,`入口の石碑`,2,16,`tablet`),Qe(-14,15,`forest`),C[C.length-1].name=M.chests.includes(`forest`)?`空の宝箱`:`西回廊の宝箱`,Qe(14,-5,`sanctum`),C[C.length-1].name=M.chests.includes(`sanctum`)?`空の宝箱`:`東の隠し宝箱`,He(2,.65,-10.5,.8,1.3,new $i({color:`#9bffe0`,emissive:`#53cfa9`,emissiveIntensity:1.4})),Ze(`spring`,`灯の泉`,2,-10.5,`spring`),qe(2,1,-10.5,`#9bffe0`,8);for(let e of[-4,4])for(let t of[-13,-18])He(e,Ke(e,t)+2,t,.5,4,V.stone),H(e,Ke(e,t)+4,t,1.3,.4,1.3,V.stone),U(e,t+1);H(0,5.1,-18,9,.6,1.1,V.stone),He(0,1.6,-16,3.6,.45,V.stone,24);let i=new di(new Hi(2,.075,8,64),new $i({color:`#8df7e1`,emissive:`#53dccc`,emissiveIntensity:3}));i.position.set(0,1.9,-16),i.rotation.x=-Math.PI/2,y.add(i),qe(0,4,-16,`#60ffe0`,22);let a=Ge(`boss`,0,-16,5);M.quest<3&&r?Ze(`boss`,`虚ろの灯守 ヴェルグ`,0,-16,`boss`).mesh=a:a.visible=!1,Ze(`exit`,`琥珀の丘へ`,0,21,`field`)}let c=new $i({color:e?`#4c8770`:`#a1b26b`,side:2}),u=new Vi(.1,.42);c.userData.kind=`grass`,c.onBeforeCompile=e=>{e.uniforms.uTime=l,e.vertexShader=`uniform float uTime;
attribute float windWeight;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
transformed.x+=sin(uTime*2.+position.x)*windWeight*.12;`)},u.setAttribute(`windWeight`,new dr([1,1,0,0],1));for(let t=0;t<(a?180:o?420:650);t++){let n=Be(t+1e3)*44-22,r=Be(t+2e3)*44-22;if(M.area===2&&Math.abs(n)<16&&Math.abs(r)<20||Math.abs(n)<3||M.area===0&&Math.abs(n)<15&&r<15||Math.abs(n-(M.area===0?-6:M.area===1?-11:9))<3)continue;let i=new di(u,c);i.position.set(n,Ke(n,r)+.17,r),i.rotation.y=t,y.add(i),a&&t%4==0&&(D.push(i),i.userData.dynamic=!0),t%8==0&&H(n,Ke(n,r)+.35,r,.09,.09,.09,new $i({color:e?`#7fdfdd`:`#ffe4ac`,emissive:e?`#53a8a8`:`#5a471c`,emissiveIntensity:e?1:.1}),!1)}let p=o?80:120,m=new Float32Array(p*3);for(let e=0;e<p;e++)m[e*3]=Be(e+58)*42-21,m[e*3+1]=Be(e+922)*7+.4,m[e*3+2]=Be(e+88)*42-21;let h=new Cr;h.setAttribute(`position`,new cr(m,3)),ee=new Oi(h,new Ci({color:e?`#adfff0`:`#ffe0a0`,size:.065,transparent:!0,opacity:.75,blending:2,depthWrite:!1})),ee.material.onBeforeCompile=e=>{e.uniforms.uTime=l,e.vertexShader=`uniform float uTime;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
transformed.y=mod(position.y+uTime*.13,8.);transformed.x+=sin(uTime*.3+position.y)*.3;`)},y.add(ee),b=Ge(`hero`,M.x,M.z,2.2),x=Ge(`mage`,M.x+1,M.z+1,2.1),x.visible=M.quest>0,ye.set(M.x,1,M.z),be.set(M.x+15,21,M.z+24),f.position.copy(be),f.lookAt(ye),et();{let e=Ol(y);d.userData.batches=e}et(),i.shadowMap.needsUpdate=!0,Me=!0,bt()}function G(e=!1){try{localStorage.setItem(`lumenfall-v1`,JSON.stringify({...M,version:1})),e&&it(`冒険を記録しました`)}catch{it(`保存できません。ブラウザの保存設定をご確認ください`)}}function rt(){try{let e=JSON.parse(localStorage.getItem(`lumenfall-v1`)||`null`);if(!e||e.version!==1||![0,1,2].includes(e.area)||!Number.isFinite(e.hp)||!Number.isFinite(e.x)||!Number.isFinite(e.z)||!Array.isArray(e.wins)||!Array.isArray(e.chests))throw Error();M={...Yl(),...e},M.seals=Array.isArray(e.seals)?e.seals.filter(e=>[`west`,`east`].includes(e)):[],M.area===2&&(e.dungeonVersion!==1||!Fl(M.x,M.z,M.seals,M.quest))&&(M.x=0,M.z=18),M.dungeonVersion=1,M.x=Math.max(-21,Math.min(21,M.x)),M.z=Math.max(-21,Math.min(21,M.z)),M.hp=Math.max(1,Math.min(Re(),M.hp)),O=`explore`,k=``,nt(),it(`記録した冒険を再開しました`)}catch{it(`読み込める記録がありません`)}}function it(e){le=e,ue=P+3,bt()}function at(e,t,n){A=e,te=[...t],j=n,k=`dialogue`,ie=null,bt()}function ot(){if(k===`dialogue`){if(te.shift(),!te.length){k=``;let e=j;j=void 0,e?.()}bt()}}function st(){M=Yl(),O=`explore`,k=``,nt(),at(`灯守のエダ`,[`水路の灯が、ひとつずつ消えている。森の「暁の種」が、眠ってしまったんだ。`,`リオ、灯を届けてくれるかい？ 星読みのミナが一緒に行くよ。北の道から琥珀の丘へお行き。`,`剣だけでは砕けない闇もある。ミナの星火と、癒しの光を頼るんだよ。`],()=>{M.quest=1,x.visible=!0,G(),it(`ミナが同行した。北の森へ向かおう`)})}function ct(e){M.area=e,M.x=0,M.z=e===0?-17:e===1?M.z<0?18:-18:18,oe=void 0,ie=null,ae=[],nt(),G(),it(Xl[e][0]),e===2&&M.quest<3&&at(`ミナ`,[`ここは星眠りの遺跡。奥の祭壇は、双灯の封印で閉ざされている。`,`左右の回廊を探索しよう。入口の石碑に、封印を解く手がかりがありそう。`])}function lt(e=oe){if(!(!e||k||O!==`explore`)){if(ie=null,ae=[],ut(523,.08),e.kind===`elder`&&at(`灯守のエダ`,M.quest===3?[`おかえり、リオ。水路に朝が戻ったね。あなたたちがつないだ灯を、私たちは守り続けるよ。`]:[`暁の種は、北の森の祭壇にある。丘の魔物で腕を磨いて、回復の準備を忘れずに。`]),e.kind===`tablet`&&at(`入口の石碑`,[`「西には、夜を照らす静かな円。東には、朝を告げる燃える円。」`,`「二つの番獣を鎮め、正しい紋章を祠に捧げよ。双灯がともるとき、祭壇への扉は開く。」`]),e.kind===`seal`){let t=Nl.find(t=>t.id===e.id);if(M.seals.includes(e.id)){at(t.name,[`この祠の封印は解かれている。`]);return}if(!M.wins.includes(t.guardian)){at(`ミナ`,[t.enemy+`の気配が、祠を覆っている。先に回廊の番獣を鎮めよう。`]);return}k=`seal-`+e.id,bt()}if(e.kind===`gate`&&at(`双灯の扉`,Pl(M.seals,M.quest)?[`二つの灯がともり、祭壇への道が開いている。奥の灯の泉で休んでから進もう。`]:[`扉は固く閉ざされている。左右の回廊にある二つの祠の封印を解除しよう。`,`解放した祠：`+M.seals.length+` / 2`]),e.kind===`spring`){if(M.springUsed){at(`灯の泉`,[`泉の灯は、静かに眠っている。`]);return}M.hp=Re(),M.mp=ze(),M.springUsed=!0,G(),at(`灯の泉`,[`あたたかな光がふたりを包んだ。HP・MPが全回復した！`])}if(e.kind===`shop`&&(k=`shop`,bt()),e.kind===`inn`&&(k=`inn`,bt()),e.kind===`traveler`&&at(`旅の薬師`,[`この先は星眠りの遺跡。左右の回廊で二つの封印を解かなければ、祭壇には進めない。`,`「身を守る」でしのげば、傷は小さくなるよ。星火に弱いという噂もある。`]),e.kind===`chest`){if(M.chests.includes(e.id)){it(`宝箱は空っぽだ`);return}M.chests.push(e.id),M.gold+=25,M.potions+=2,e.id===`forest`&&(M.ethers+=2),e.name=`空の宝箱`,G(),at(`宝箱`,[`25 G と 薬草 ×2 を手に入れた！`+(e.id===`forest`?` 星の雫 ×2 も入っていた。`:``)])}if(e.kind===`exit`){if(M.quest===0){at(`ミナ`,[`出発する前に、町の灯守エダに話を聞こう。`]);return}ct(e.id===`town`?0:e.id===`field`?1:2)}if(e.kind===`boss`&&!Pl(M.seals,M.quest)){it(`先に二つの封印を解除しよう`);return}(e.kind===`enemy`||e.kind===`boss`)&&ht(e)}}function ut(e,t=.2,n=`sine`,r=.045){if(_e||!ge)return;let i=ge.createOscillator(),a=ge.createGain();i.type=n,i.frequency.value=e,a.gain.setValueAtTime(r,ge.currentTime),a.gain.exponentialRampToValueAtTime(.001,ge.currentTime+t),i.connect(a),a.connect(ge.destination),i.start(),i.stop(ge.currentTime+t)}function dt(){ge||=new AudioContext,ge.state===`suspended`&&ge.resume()}function ft(e,t,n,r,i=100){i=Math.ceil(i*(a?.35:o?.7:1));let s=new Float32Array(i*3),c=[];for(let r=0;r<i;r++)s[r*3]=e,s[r*3+1]=t,s[r*3+2]=n,c.push(new J((Math.random()-.5)*10,Math.random()*7,(Math.random()-.5)*10));let l=new Cr;l.setAttribute(`position`,new cr(s,3));let u=new Oi(l,new Ci({color:r,size:.12,blending:2,transparent:!0,depthWrite:!1}));l.setAttribute(`velocity`,new dr(c.flatMap(e=>[e.x,e.y,e.z]),3));let d={value:0};u.material.onBeforeCompile=e=>{e.uniforms.uAge=d,e.vertexShader=`uniform float uAge;
attribute vec3 velocity;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
transformed+=velocity*uAge;transformed.y-=2.5*uAge*uAge;`)},u.frustumCulled=!1,u.userData={age:d,life:1.3},y.add(u),he.push(u)}function pt(e,t=!1){let n=document.createElement(`div`);n.className=`damage`,n.textContent=e,t&&(n.style.left=`30%`,n.style.color=`#acffdc`),document.getElementById(`floaters`).append(n),Le(()=>n.remove(),1100)}function mt(e=!1){de=e?.42:.2,fe=.09,v.color.set(e?`#8bf5ff`:`#ffd1a0`),v.intensity=e?65:25,n.style.background=e?`#b8fff6`:`#ffe4b8`,n.style.opacity=e?`.22`:`.1`,Le(()=>n.style.opacity=`0`,110),ut(e?880:130,.3,e?`sine`:`triangle`,.08)}function ht(e){let t=e.kind===`boss`;O=`battle`,pe=!0,oe=void 0,I={id:e.id,boss:t,name:e.name,hp:t?245:e.id===`slime`?42:e.id.startsWith(`sentinel`)?78:60,max:t?245:e.id===`slime`?42:e.id.startsWith(`sentinel`)?78:60,turn:0,charge:!1,phase:1,origin:{x:M.x,z:M.z},obj:e},b.position.set(M.x-2,Ke(M.x,M.z),M.z+1),x.position.set(M.x-3,Ke(M.x,M.z),M.z+3),S=e.mesh,S.position.set(M.x+3,Ke(M.x,M.z),M.z-2),me=t?`祭壇の灯が脈打つ。虚ろの灯守が目覚めた。`:`魔物が行く手をふさいだ！`,t&&(m.strength=1.1,ft(S.position.x,3,S.position.z,`#79ffee`,160),mt(!0)),bt(),Le(()=>{pe=!1,me=`リオたちは どうする？`,bt()},1500)}function gt(e){if(O!==`battle`||pe||e===`fire`&&M.mp<6||e===`heal`&&M.mp<5||e===`potion`&&M.potions<=0||e===`ether`&&M.ethers<=0)return;pe=!0;let t=S,n=0,r=!1;if(I.turn++,e===`attack`&&(n=17+M.lv*4+(M.sword?9:0),me=`リオの攻撃！`,xe=1,Le(()=>{mt(),ft(t.position.x,1.8,t.position.z,`#ffe2a0`,50)},350)),e===`fire`&&(M.mp-=6,n=33+M.lv*6+(I.boss?9:0),me=`ミナは 星火 を唱えた！`,v.color.set(`#63cfff`),v.intensity=30,xe=2,ft(b.position.x,2,b.position.z,`#87eaff`,75),Le(()=>{mt(!0),ft(t.position.x,2.5,t.position.z,`#80eaff`,160)},650)),e===`heal`){M.mp-=5;let e=Math.min(Re()-M.hp,58);M.hp+=e,me=`ミナの 灯の癒し。HPが回復した！`,ft(b.position.x,1,b.position.z,`#b1ffd4`,65),pt(`+`+e,!0),ut(660,.7)}if(e===`potion`){M.potions--;let e=Math.min(Re()-M.hp,65);M.hp+=e,me=`薬草を使った。HPが回復した！`,pt(`+`+e,!0)}e===`ether`&&(M.ethers--,M.mp=Math.min(ze(),M.mp+20),me=`星の雫を使った。MPが20回復した！`,ut(740,.4)),e===`guard`&&(r=!0,me=`リオたちは 身を守っている。`),bt(),Le(()=>{n&&(I.hp=Math.max(0,I.hp-n),pt(String(n)),bt())},e===`fire`?700:400),Le(()=>{if(xe=0,I.hp<=0){vt();return}I.boss&&I.hp<=I.max*.5&&I.phase===1?(I.phase=2,d.fog=new On(`#43304f`,.037),_.color.set(`#ba91ec`),m.strength=1.35,me=`灯守の核が露わになった。森が紫の炎に包まれる！`,mt(!0),ft(t.position.x,3,t.position.z,`#d48cff`,180),bt(),Le(()=>_t(r),1300)):_t(r)},1500)}function _t(e){if(!I)return;if(I.boss&&!I.charge&&I.turn%3==1){I.charge=!0,me=`ヴェルグが光を集めている… 次の一撃に備えよう！`,v.color.set(`#e5a3ff`),v.intensity=25,ft(S.position.x,2,S.position.z,`#c892ff`,70),ut(160,.8,`triangle`),pe=!1,bt();return}let t=I.charge,n=I.boss?t?43:I.phase===2?23:18:I.id===`slime`?9:14;n=Math.max(1,n-(M.armor?5:0)),e&&(n=Math.ceil(n*.25)),I.charge=!1,M.hp=Math.max(0,M.hp-n),me=(t?`ヴェルグの 月蝕の奔流！`:I.name+`の攻撃！`)+` `+n+` ダメージ`+(e?`（防御）`:``),pt(`-`+n,!0),mt(t),ft(b.position.x,1.5,b.position.z,t?`#c491ff`:`#ffdba1`,t?130:40),bt(),Le(()=>{M.hp<=0?(O=`explore`,I=null,k=``,M.hp=Re(),M.mp=ze(),M.area=0,M.x=-10,M.z=5,M.gold=Math.max(0,M.gold-10),nt(),at(`宿の主人`,[`大丈夫、ここは水鳥亭。旅人が運んできてくれたんだ。`,`治療代は10 G。装備を整えて、もう一度挑んでごらん。`]),G()):(pe=!1,me=`リオたちは どうする？`,bt())},1e3)}function vt(){let e=I.boss,t=I.id,n=e?100:t===`slime`?24:36,r=e?80:25;M.xp+=n,M.gold+=r,M.wins.includes(t)||M.wins.push(t);let i=!1;for(;M.xp>=M.lv*30;)M.xp-=M.lv*30,M.lv++,i=!0;M.hp=i?Re():M.hp,M.mp=i?ze():M.mp,me=`勝利！ `+n+` EXP / `+r+` G`+(i?`　レベルアップ！ HP・MP全回復`:``),S.visible=!1,ft(S.position.x,2,S.position.z,`#ffe2a2`,150),ut(523,.2),Le(()=>ut(659,.25),200),Le(()=>ut(784,.7),400),bt(),Le(()=>{O=`explore`,I=null,m.strength=.65,nt(),e?(M.quest=3,G(),at(`ミナ`,[`見て。あの人は、灯を守ろうとして闇を抱え込んでいたんだね。`,`暁の種が、あたたかい。帰ろう、リオ。みんなの灯が待ってる。`],()=>{M.area=0,M.x=0,M.z=8,nt(),_.color.set(`#ffe8bc`),_.intensity=4,d.fog=new On(`#c5c6b0`,.018),O=`ending`,G(),bt()})):(G(),it(i?`レベル `+M.lv+` になった！`:`道が開けた。先へ進もう`))},1900)}function yt(){return`<div class="party"><small>Lv. ${M.lv}</small><b>リオ <span style="font-size:11px;color:#bbc9cb">& ミナ</span></b><div class="stat"><span>HP</span><div class="bar"><i style="width:${M.hp/Re()*100}%"></i></div><span>${M.hp}/${Re()}</span></div><div class="stat"><span>MP</span><div class="bar mp"><i style="width:${M.mp/ze()*100}%"></i></div><span>${M.mp}/${ze()}</span></div></div>`}function K(e,t,n=!1){return`<button data-action="${e}" ${n?`disabled`:``}>${t}</button>`}function bt(){Me=!1;let e=Ye(),n=`<div class="vignette"></div>`;if(O===`title`){let e=!1;try{e=!!localStorage.getItem(`lumenfall-v1`)}catch{}n+=`<div class="title"><div class="eyebrow">A TALE OF THE LAST LIGHT</div><h1>灯の継承者</h1><div class="subtitle">L U M E N F A L L</div><p>消えゆく灯。小さな約束。<br>夜明けをつなぐ、ふたりの旅。</p>${K(`new`,`はじめから　 →`)}${e?K(`load`,`つづきから`):``}</div><div class="corner">A SHORT FANTASY · 約15分の冒険</div>`}else O===`ending`?n+=`<div class="overlay"><div class="panel ending"><div class="eyebrow">THE LIGHT WILL LIVE ON</div><h1>そして、灯はつづく</h1><div class="sep"></div><p>朝の光が、水路を金色に染めた。<br>名もなき小さな勇気が、<br>今日も誰かの窓に灯をともす。</p><p>リオとミナの旅は、ここでひと休み。<br>けれど、世界にはまだ多くの夜がある。</p><div class="badge">THE END</div><p style="font-size:12px">到達レベル ${M.lv} · 討伐 ${M.wins.length} · 宝箱 ${M.chests.length}/4</p>${K(`after`,`灯の戻った町へ`)}</div></div>`:O===`battle`?n+=`<div class="battle"><div class="battlehead"><div class="eyebrow">${I.boss?`GUARDIAN OF THE HOLLOW LIGHT`:`ENCOUNTER`}</div><h2>${I.name}</h2><div class="enemybar"><i style="width:${I.hp/I.max*100}%"></i></div><p style="font:11px Arial;color:#ddd4c2">${I.hp} / ${I.max}${I.charge?`　 ⚠ 次の攻撃に備えよう`:``}</p></div><div class="bottom">${yt()}</div><div class="battlelog">${me}</div><div class="commands">${K(`attack`,`剣で攻撃<small>SWORD</small>`,pe)}${K(`fire`,`星火<small>MP 6 · 光の攻撃</small>`,pe||M.mp<6)}${K(`heal`,`灯の癒し<small>MP 5 · HP回復</small>`,pe||M.mp<5)}${K(`guard`,`身を守る<small>被ダメージを軽減</small>`,pe)}${K(`potion`,`薬草 ×${M.potions}<small>HP +65</small>`,pe||!M.potions)}${K(`ether`,`星の雫 ×${M.ethers}<small>MP +20</small>`,pe||!M.ethers)}</div></div>`:n+=`<div class="top"><div class="region"><small>${Xl[M.area][1]}</small><h2>${Xl[M.area][0]}</h2><p>${Xl[M.area][2]} · ${M.area===2?`月夜`:Math.sin(P*.015)>.6?`夕暮れ`:`午後`}</p></div><div class="tools"><button class="iconbtn" data-action="sound" aria-label="音の切り替え">${_e?`♪̸`:`♪`}</button><button class="iconbtn" data-action="map" aria-label="周辺の案内">⌖</button><button class="iconbtn" data-action="menu" aria-label="冒険メニュー">☰</button></div></div><div class="quest"><small>${M.quest===3?`旅の記憶`:`次の目的地`}</small><div class="journey"><span class="${M.area===0?`current`:``}">町</span> › <span class="${M.area===1?`current`:``}">草原</span> › <span class="${M.area===2?`current`:``}">遺跡</span> › 祭壇</div><span class="quest-copy">${M.quest===0?`灯守のエダに話を聞こう`:M.quest===3?`町に灯が戻った。自由に散策しよう`:M.area===0?`北の道から、琥珀の丘へ`:M.area===1?`街道を北へ進み、星眠りの遺跡へ`:Pl(M.seals,M.quest)?`双灯の扉が開いた。奥の祭壇へ`:`左右の回廊を探索し、祠の封印を解く（`+M.seals.length+`/2）`}</span>${e?`<button class="guide" data-action="guide"><span class="guide-full">${Math.hypot(e.x-M.x,e.z-M.z)<e.r?`ここから進む · `:`⌖ `}${M.area===0?`北門 → 琥珀の丘`:M.area===1?`森の入口 → 星眠りの遺跡`:e.name}${Math.hypot(e.x-M.x,e.z-M.z)<e.r?``:`まで案内`}</span><span class="guide-compact">${Math.hypot(e.x-M.x,e.z-M.z)<e.r?`進む · `:`⌖ `}${M.area===0?`琥珀の丘へ`:M.area===1?`星眠りの遺跡へ`:e.name}${M.area===2&&!Pl(M.seals,M.quest)?`　`+M.seals.length+`/2`:``}</span></button>`:``}</div><div class="bottom">${yt()}<div class="help">WASD / 矢印キー · 移動　 E / Space · 調べる<br>地面をクリック · 移動　 Esc · メニュー</div></div>${oe&&!k?`<button class="interact" data-action="interact"><em>E</em>${oe.name}</button>`:``}<div class="joystick" id="joystick" aria-label="移動スティック"><i></i></div>`;if(k===`dialogue`&&(n+=`<div class="dialogue"><b>${A}</b><p>${te[0]}</p>${K(`next`,te.length>1?`つづける　 ▸`:`閉じる　 ▸`)}<div style="clear:both"></div></div>`),k===`menu`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">TRAVEL JOURNAL</div><h2>冒険の記録</h2><p>リオとミナ　Lv. ${M.lv}　 /　${M.gold} G<br>経験値 ${M.xp} / ${M.lv*30}<br>武器：${M.sword?`暁鉄の剣（攻撃 +9）`:`旅立ちの剣`}<br>防具：${M.armor?`織星の外套（被ダメージ −5）`:`旅人の服`}</p>${K(`usepotion`,`薬草を使う ×${M.potions}　 HP +65`,!M.potions||M.hp===Re())}${K(`useether`,`星の雫を使う ×${M.ethers}　 MP +20`,!M.ethers||M.mp===ze())}${K(`save`,`冒険を記録する`)}${K(`load`,`記録から再開する`)}${K(`quality`,`画質：`+(c===`auto`?`自動調整`:c===`high`?`高画質`:`軽量`))}<p id="renderStats" style="font:12px Arial;line-height:1.6"></p>${K(`controls`,`操作方法`)}${K(`close`,`旅に戻る`)}</div></div>`),k.startsWith(`seal-`)){let e=Nl.find(e=>e.id===k.slice(5));n+=`<div class="overlay"><div class="panel"><div class="eyebrow">SEAL OF THE TWIN LIGHTS</div><h2>${e.name}</h2><p>番獣の気配は消えた。<br>台座に捧げる紋章を選ぼう。<br><br>石碑の言葉：<br>「西には、夜を照らす静かな円。<br>東には、朝を告げる燃える円。」</p>${K(`glyph-moon`,`月の紋章`)}${K(`glyph-sun`,`太陽の紋章`)}${K(`glyph-star`,`星の紋章`)}${K(`close`,`あとで考える`)}</div></div>`}if(k===`map`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">NEARBY</div><h2>周辺の案内</h2><p>目的地を選ぶと、歩いて向かいます。</p>${C.filter(e=>(e.kind!==`chest`||!M.chests.includes(e.id))&&(e.kind!==`spring`||Pl(M.seals,M.quest))).map(e=>K(`walk-`+e.id,e.name)).join(``)}${K(`close`,`戻る`)}</div></div>`),k===`shop`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">LYUNE TRADING POST</div><h2>旅支度の店</h2><p>「小さな備えが、旅を助けるよ。」<br>所持金：${M.gold} G</p>${K(`buy-potion`,`薬草　15 G　／ HP +65`,M.gold<15)}${K(`buy-ether`,`星の雫　20 G　／ MP +20`,M.gold<20)}${K(`buy-sword`,M.sword?`暁鉄の剣　装備中`:`暁鉄の剣　40 G　／ 攻撃 +9`,M.sword||M.gold<40)}${K(`buy-armor`,M.armor?`織星の外套　装備中`:`織星の外套　35 G　／ 被ダメージ −5`,M.armor||M.gold<35)}${K(`close`,`店を出る`)}</div></div>`),k===`inn`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">THE WATERBIRD INN</div><h2>水鳥亭</h2><p>「今夜は、窓の灯を消さずにおくよ。」<br>一泊 10 G。HP・MPをすべて回復します。<br>所持金：${M.gold} G</p>${K(`rest`,M.gold>=10?`ひと休みする　10 G`:`ひと休みする（今回は無料）`)}${K(`close`,`宿を出る`)}</div></div>`),k===`controls`&&(n+=`<div class="overlay"><div class="panel"><h2>旅の手引き</h2><p>移動：WASD / 矢印キー。地面のクリック・タップでも移動できます。スマホでは左下のスティックを使えます。<br><br>会話・宝箱・出入口：近づいて E / Space、または表示されたボタン。<br><br>戦闘はコマンド選択式。敵が力をためたら「身を守る」。HPが減ったら薬草や癒しの魔法を。<br><br>エリア移動・勝利・買い物時に自動保存。メニューから手動でも保存できます。記録はこのブラウザに保存されます。</p>${K(`close`,`戻る`)}</div></div>`),le&&P<ue&&(n+=`<div class="toast">${le}</div>`),n===L)return;L=n;let r=t.querySelector(`#joystick`);if(r&&ne&&O===`explore`&&!k){let e=document.createElement(`template`);e.innerHTML=n,e.content.querySelector(`#joystick`)?.remove();for(let e of[...t.childNodes])e!==r&&e.remove();t.append(e.content)}else{ne?.(),ne=void 0,t.innerHTML=n;let e=t.querySelector(`#joystick`);e&&O===`explore`&&!k?ne=kl(e,(e,t)=>{re={x:e,y:t},ie=null,ae=[]}):re={x:0,y:0}}}function xt(e){let t=e.target.closest(`[data-action]`);if(!t||t.disabled)return;dt();let n=t.dataset.action;if(O===`battle`){gt(n);return}if(ut(440,.04),n.startsWith(`glyph-`)&&k.startsWith(`seal-`)){let e=Nl.find(e=>e.id===k.slice(5));if(n.slice(6)!==e.answer){it(`紋章が淡く揺れた。石碑の言葉を思い出そう。`);return}M.seals.push(e.id),k=``,nt(),G(),ft(e.x,2,e.z,e.color,100),at(`ミナ`,Pl(M.seals,M.quest)?[`二つの灯がつながった！ 双灯の扉が開いたよ。`,`奥に回復の泉がある。準備を整えて、祭壇へ進もう。`]:[e.name+`の封印が解けた。もう一方の回廊へ行こう。`]),bt();return}if(n===`quality`){c=c===`auto`?`high`:c===`high`?`low`:`auto`;try{localStorage.setItem(`lumenfall-quality`,c)}catch{}s.scale=1,Ot()}if(n===`guide`){let e=Ye();e&&(Math.hypot(e.x-M.x,e.z-M.z)<e.r?lt(e):(kt(e.x,e.z),it(`目的地まで歩いて案内します`)))}if(n===`new`&&st(),n===`load`&&rt(),n===`next`&&ot(),n===`interact`&&lt(),n===`menu`&&(k=k?``:`menu`,ie=null),n===`close`&&(k=``),n===`controls`&&(k=`controls`),n===`map`&&(k=`map`),n.startsWith(`walk-`)){let e=C.find(e=>e.id===n.slice(5));k=``,e&&kt(e.x,e.z)}if(n===`sound`&&(_e=!_e),n===`save`&&G(!0),n===`after`&&(O=`explore`,k=``,G()),n===`usepotion`&&M.potions&&(M.potions--,M.hp=Math.min(Re(),M.hp+65),G()),n===`useether`&&M.ethers&&(M.ethers--,M.mp=Math.min(ze(),M.mp+20),G()),n.startsWith(`buy-`)){let e=n.slice(4),t=e===`potion`?15:e===`ether`?20:e===`sword`?40:35;M.gold>=t&&(M.gold-=t,e===`potion`&&M.potions++,e===`ether`&&M.ethers++,e===`sword`&&(M.sword=!0),e===`armor`&&(M.armor=!0),G(),it(e===`sword`||e===`armor`?`購入して装備した`:`購入した`))}n===`rest`&&(M.gold=Math.max(0,M.gold-10),M.hp=Re(),M.mp=ze(),k=``,G(),at(`宿の主人`,[`ゆっくり休めたかい？ HP・MPが全回復したよ。いってらっしゃい。`])),bt()}t.addEventListener(`click`,xt);let Ct=e=>{[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,` `,`Tab`].includes(e.key)&&e.key!==`Tab`&&e.preventDefault(),N.add(e.key.toLowerCase()),!e.repeat&&(dt(),e.key===`Escape`&&O===`explore`&&(k===`dialogue`?ot():(k=k?``:`menu`,bt())),[`e`,`E`,` `,`Enter`].includes(e.key)&&(k===`dialogue`?ot():O===`explore`&&!k&&lt()))},wt=e=>N.delete(e.key.toLowerCase()),Tt=()=>{N.clear(),re={x:0,y:0},ie=null,ae=[]};window.addEventListener(`keydown`,Ct),window.addEventListener(`keyup`,wt),window.addEventListener(`blur`,Tt);let Y=new no,Et=new vi(new J(0,1,0),0),Dt=e=>{if(O!==`explore`||k)return;let t=new q(e.clientX/innerWidth*2-1,-e.clientY/innerHeight*2+1);Y.setFromCamera(t,f);let n=new J;Y.ray.intersectPlane(Et,n)&&kt(St.clamp(n.x,-21,21),St.clamp(n.z,-21,21))};e.addEventListener(`pointerdown`,Dt);function Ot(){let t=c===`low`?.7:c===`high`?1.2:s.scale;i.setPixelRatio(a?1:El(innerWidth,innerHeight,devicePixelRatio,o,t)),i.setSize(innerWidth,innerHeight),a||(p.setPixelRatio(i.getPixelRatio()),p.setSize(innerWidth,innerHeight),m.setSize(innerWidth*i.getPixelRatio()*.5,innerHeight*i.getPixelRatio()*.5)),f.aspect=innerWidth/innerHeight,f.updateProjectionMatrix(),h.uniforms.resolution.value.set(e.width,e.height)}window.addEventListener(`resize`,Ot),Ot(),nt(),document.getElementById(`loading`)?.remove();function kt(e,t){let n=.75,r=[Math.round(M.x/n),Math.round(M.z/n)],i=[r],a=new Set([r.join(`,`)]),o=new Map,s=``;for(let r=0;r<i.length&&r<5e3;r++){let[c,l]=i[r];if(Math.hypot(c*n-e,l*n-t)<1.2){s=[c,l].join(`,`);break}for(let[e,t]of[[0,1],[0,-1],[1,0],[-1,0]]){let r=c+e,s=l+t,u=[r,s].join(`,`);!a.has(u)&&X(r*n,s*n)&&(a.add(u),o.set(u,[c,l].join(`,`)),i.push([r,s]))}}if(s){let e=[];for(;o.has(s);){let[t,r]=s.split(`,`).map(Number);e.push(new J(t*n,0,r*n)),s=o.get(s)}ae=e.reverse(),ie=ae.shift()??null}else it(`そこへは歩いて行けないようだ`)}function X(e,t){return e>-22&&e<22&&t>-22&&t<22&&(M.area!==2||Fl(e,t,M.seals,M.quest))&&!w.some(n=>Math.abs(e-n.x)<n.w/2+.23&&Math.abs(t-n.z)<n.d/2+.23)}function At(){ce=a?window.setTimeout(()=>Mt(performance.now()),16):requestAnimationFrame(Mt)}function jt(){Tt(),document.hidden?(cancelAnimationFrame(ce),clearTimeout(ce)):(se=performance.now(),we=0,Oe=ke=0,Ae=se,At())}document.addEventListener(`visibilitychange`,jt);function Mt(t){if(F||document.hidden||(At(),!a&&t-we<16))return;a||(we=t-(t-we)%(1e3/60));let n=t-se,r=Math.min(n/1e3,.045);if(se=t,P+=r,M.time+=r,l.value=P,de*=Math.exp(-r*7.67),fe=Math.max(0,fe-r),v.intensity*=Math.exp(-r*4.35),le&&P>ue&&(le=``,Me=!0),Oe+=n,ke++,t-Ae>1e3){je=Math.round(1e3/(Oe/Math.max(1,ke))),!a&&c===`auto`&&!pe&&fe===0&&s.sample(Oe/Math.max(1,ke))&&Ot(),Oe=ke=0,Ae=t;let n=document.getElementById(`renderStats`);n&&(n.textContent=`${a?`互換描画（GPUを利用できません）`:`WebGL`} · ${je} fps · ${e.width} × ${e.height} · 描画グループ ${d.userData.batches?.after??0}`)}if(P-Ee>.2){Ee=P;let e=O===`title`?ye:b.position;Fe.sort((t,n)=>t.position.distanceToSquared(e)-n.position.distanceToSquared(e)),z.forEach((e,t)=>{let n=Fe[t];n?(e.position.copy(n.position),e.color.copy(n.color),e.intensity=n.power):e.intensity=0})}if(!a&&P-Te>.5&&(Te=P,M.area!==2&&(_.position.x=-18+Math.sin(P*.012)*10,i.shadowMap.needsUpdate=!0)),ge&&!_e&&P>ve){ve=P+(O===`battle`?.4:1.1);let e=O===`battle`?[146.83,220,293.66,349.23,440]:M.area===2?[196,293.66,392,440,587.33]:[220,329.63,440,493.88,659.25];ut(e[Math.floor(P*1.1)%e.length],1.8,`sine`,.016)}if(P-De>1/30){De=P;for(let e of E)e.scale.y=1.05+Math.sin(P*13+e.position.x)*.18;for(let e of D)e.rotation.z=Math.sin(P*2+e.position.x)*.12}for(let e=he.length-1;e>=0;e--){let t=he[e];t.userData.life-=r,t.userData.age.value=1.3-t.userData.life,t.material.opacity=Math.max(0,t.userData.life/1.3),t.userData.life<=0&&(y.remove(t),t.geometry.dispose(),t.material.dispose(),he.splice(e,1))}if(O===`explore`&&!k){let e=0,t=0,n=(N.has(`d`)||N.has(`arrowright`)?1:0)-(N.has(`a`)||N.has(`arrowleft`)?1:0)+re.x,i=(N.has(`s`)||N.has(`arrowdown`)?1:0)-(N.has(`w`)||N.has(`arrowup`)?1:0)+re.y;n||i?(ie=null,ae=[],e=n*.85+i*.53,t=-n*.53+i*.85):ie&&(e=ie.x-M.x,t=ie.z-M.z,Math.hypot(e,t)<.18&&(ie=ae.shift()??null,e=t=0));let a=Math.hypot(e,t);if(a>.01){e/=a,t/=a;let n=M.x+e*r*5,i=M.z+t*r*5,o=!1;X(n,M.z)&&(M.x=n,o=!0),X(M.x,i)&&(M.z=i,o=!0),o||(ie=null),b.material.rotation=Math.sin(P*15)*.035,b.position.y=Ke(M.x,M.z)+Math.abs(Math.sin(P*12))*.07,b.material.map.repeat.x=1,b.material.map.offset.x=0}else b.material.rotation=0,b.position.y=Ke(M.x,M.z)+.06;b.position.x=M.x,b.position.z=M.z;let o,s=1/0;for(let e of C){let t=(e.x-M.x)**2+(e.z-M.z)**2;t<e.r*e.r&&t<s&&(s=t,o=e)}o!==oe&&(oe=o,Me=!0)}if(O!==`battle`){if(x.position.lerp(Se.set(M.x+1,Ke(M.x+1,M.z+1)+.06,M.z+1),r*4),O===`title`)ye.set(-1,1,0),be.set(22+Math.sin(P*.05)*3,24,31);else{ye.set(M.x,1,M.z-1);let e=innerWidth<600;be.set(M.x+(e?19:15),e?27:21,M.z+(e?30:24))}if(M.area!==2){let e=.5+.5*Math.sin(P*.015);_.color.setHSL(.105-e*.045,.52,.8),_.intensity=3.8-e*1.3}}else{let e=b.position,t=S.position,n=innerWidth<600,r=P*(I.boss?.24:.12);ye.set((e.x+t.x)/2,1.5,(e.z+t.z)/2);let i=n?I.boss?35:29:17;be.set(ye.x+Math.sin(r)*3+6,xe===2?9:12,ye.z+i-(xe?3:0)),I.boss&&(S.position.y=Ke(M.x,M.z)+Math.sin(P*2)*.15,S.material.color.set(I.phase===2?`#e0bdff`:`#d7fffa`))}f.position.lerp(be,r*(O===`battle`?2.3:3));let o=Ce.copy(ye);de&&(f.position.x+=(Math.random()-.5)*de,f.position.y+=(Math.random()-.5)*de),f.lookAt(o);for(let e of[b,x])e.userData.shadow.position.set(e.position.x,Ke(e.position.x,e.position.z)+.025,e.position.z);Me&&bt(),fe<=0&&p.render()}return At(),()=>{F=!0,ne?.(),cancelAnimationFrame(ce),clearTimeout(ce),B.forEach(clearTimeout),window.removeEventListener(`keydown`,Ct),window.removeEventListener(`keyup`,wt),window.removeEventListener(`blur`,Tt),window.removeEventListener(`resize`,Ot),document.removeEventListener(`visibilitychange`,jt),e.removeEventListener(`pointerdown`,Dt),t.removeEventListener(`click`,xt),ge?.close(),et(),tt(),Object.values(V).forEach(e=>e.dispose()),We.forEach(e=>e.dispose()),p.dispose(),i.dispose()}}Zl();