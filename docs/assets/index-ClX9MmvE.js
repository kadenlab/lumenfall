...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Ml=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Nl=new Pa(-1,1,1,-1,0,1),Pl=new class extends Cr{constructor(){super(),this.setAttribute(`position`,new dr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new dr([0,2,0,0,2,0],2))}},Fl=class{constructor(e){this._mesh=new di(Pl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Nl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Il=class extends Ml{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Zi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ji.clone(e.uniforms),this.material=new Zi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Fl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ll=class extends Ml{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Rl=class extends Ml{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},zl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new q);this._width=n.width,this._height=n.height,t=new Ht(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Il(jl),this.copyPass.material.blending=0,this.timer=new Va}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Ll!==void 0&&(r instanceof Ll?n=!0:r instanceof Rl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new q);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Bl=class extends Ml{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Vl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`};var Wl=()=>({area:0,x:0,z:8,hp:100,mp:30,lv:1,xp:0,gold:35,potions:4,ethers:2,sword:!1,armor:!1,quest:0,chests:[],wins:[],seals:[],springUsed:!1,dungeonVersion:1,time:0}),Gl=[[`水灯の町 リュネ`,`LYUNE · THE LANTERN VILLAGE`,`夕映えの水路`],[`琥珀の丘`,`AMBER HIGHLANDS`,`風渡る旧街道`],[`星眠りの遺跡`,`MOONFALL SANCTUM`,`森に眠る双灯の迷宮`]];function Kl(){let e=document.getElementById(`world`),t=document.getElementById(`ui`),n=document.getElementById(`fade`),i,a=!1;try{i=new Cl({canvas:e,antialias:!0,powerPreference:`high-performance`})}catch{a=!0;let t=e.cloneNode();e.replaceWith(t),e=t,i=new Tl(e)}i.setPixelRatio(Math.min(devicePixelRatio,1.65)),i.shadowMap.enabled=!0,i.shadowMap.type=2,i.toneMapping=4,i.toneMappingExposure=1.18;let o=new kn,s=new ja(36,1,.1,180);o.background=new Z(`#758c98`),o.fog=new On(`#8d9b9b`,.021);let c=a?{addPass:()=>{},setSize:()=>{},dispose:()=>{},render:()=>i.render(o,s)}:new zl(i);c.addPass(new Bl(o,s));let l=new Hl(new q(800,600),.65,.5,.82);c.addPass(l);let u=new Il({uniforms:{tDiffuse:{value:null},resolution:{value:new q(800,600)},strength:{value:1.7}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`uniform sampler2D tDiffuse;uniform vec2 resolution;uniform float strength;varying vec2 vUv;void main(){float f=smoothstep(.13,.47,abs(vUv.y-.49));vec2 d=vec2(1.)/resolution*f*strength*2.;vec4 c=texture2D(tDiffuse,vUv)*.24;c+=texture2D(tDiffuse,vUv+d)*.12;c+=texture2D(tDiffuse,vUv-d)*.12;c+=texture2D(tDiffuse,vUv+vec2(d.x,-d.y))*.12;c+=texture2D(tDiffuse,vUv+vec2(-d.x,d.y))*.12;c+=texture2D(tDiffuse,vUv+vec2(0.,d.y*2.))*.07;c+=texture2D(tDiffuse,vUv-vec2(0.,d.y*2.))*.07;c+=texture2D(tDiffuse,vUv+vec2(d.x*2.,0.))*.07;c+=texture2D(tDiffuse,vUv-vec2(d.x*2.,0.))*.07;float vig=1.-.32*pow(length((vUv-.5)*1.4),1.5);gl_FragColor=vec4(c.rgb*vig,1.);}`});c.addPass(u);let d=new ya(`#c3e1ef`,`#384538`,2);o.add(d);let f=new Ia(`#ffcf85`,4);f.position.set(-14,25,9),f.castShadow=!0,f.shadow.mapSize.set(2048,2048),Object.assign(f.shadow.camera,{left:-30,right:30,top:30,bottom:-30,near:1,far:90}),f.shadow.bias=-7e-4,f.shadow.normalBias=.035,o.add(f);let p=new Na(`#85dbff`,0,35,1);p.position.set(0,5,0),o.add(p);let m=new bn;o.add(m);let h,g,_,v=[],y=[],b=[],x=[],S=[],C,w=`title`,T=``,E=[],D=``,ee,O,k=Wl(),A=new Set,j={x:0,y:0},M=null,te=[],N,P=0,ne=performance.now(),re=0,ie=!1,ae=``,oe=0,se=0,ce=0,F=null,le=!1,ue=``,de=[],fe,pe=!1,me=0,he=new J,ge=new J,_e=0,ve=[],ye=(e,t)=>{ve.push(setTimeout(()=>{ie||e()},t))},be=()=>100+(k.lv-1)*24,xe=()=>30+(k.lv-1)*8,Se=e=>{let t=Math.sin(e*127.1+311.7)*43758.5453;return t-Math.floor(t)},Ce=(e,t=.9)=>new $i({color:e,roughness:t}),I={stone:Ce(`#8b9186`),dark:Ce(`#505d58`),wall:Ce(`#ddcba6`),wood:Ce(`#665044`),roof:Ce(`#487573`),gold:Ce(`#b38a45`),ground:Ce(`#647b46`),path:Ce(`#b4a17a`)};function L(e,t,n,r,i,o,s,c=!0){let l=new di(new Fi(r,i,o,a?Math.ceil(r/3):1,1,a?Math.ceil(o/3):1),s);return l.position.set(e,t,n),l.castShadow=c,l.receiveShadow=!0,m.add(l),l}function we(e,t,n,r,i,a,o=8){let s=new di(new Li(r,r*1.08,i,o),a);return s.position.set(e,t,n),s.castShadow=!0,s.receiveShadow=!0,m.add(s),s}function Te(e){let t=document.createElement(`canvas`);t.width=48,t.height=64;let n=t.getContext(`2d`),i=(e,t,r,i,a)=>{n.fillStyle=a,n.fillRect(e,t,r,i)};if(e===`slime`){for(let e=19;e<53;e++){let t=Math.floor(Math.sqrt(Math.max(0,1-((e-37)/19)**2))*20);i(24-t,e,t*2,1,e<28?`#b3ece0`:e<40?`#61c4b0`:`#328b8d`)}i(12,26,9,5,`#dcffec`),i(15,37,4,6,`#173e48`),i(31,37,4,6,`#173e48`),i(22,47,8,2,`#244f56`)}else if(e===`wolf`)i(6,29,35,18,`#4c6280`),i(7,24,19,20,`#768eaa`),i(8,15,6,14,`#91a3b4`),i(22,18,5,12,`#617491`),i(4,34,8,8,`#9aa8b7`),i(9,48,6,10,`#3d4e69`),i(31,46,6,12,`#3d4e69`),i(13,31,4,3,`#f2c16d`),i(38,22,5,19,`#627c98`);else if(e===`boss`){for(let e=6;e<61;e++){let t=Math.floor(12+8*Math.sin(e*.11));i(24-t,e,t*2,1,e<20?`#819daf`:e<44?`#425d73`:`#293a54`)}i(9,1,5,16,`#d1bd82`),i(34,1,5,16,`#d1bd82`),i(5,23,8,19,`#789495`),i(35,23,8,19,`#789495`),i(14,22,7,3,`#fff5a9`),i(28,22,7,3,`#fff5a9`),i(21,32,7,13,`#7dedec`),i(23,34,3,9,`#e1ffff`),i(7,45,8,14,`#334454`),i(33,45,8,14,`#334454`)}else{let t=e!==`hero`,n=e===`mage`,r=n?`#d6d4dc`:t?`#89977a`:`#355f83`;i(17,8,15,6,t?`#aaa197`:`#4a3535`),i(14,13,20,13,t?`#cec1a1`:`#533b36`),i(18,15,14,14,`#e9b58c`),i(29,18,3,3,`#26313b`),i(14,13,7,11,t?`#a7a8a7`:`#684335`),i(16,29,17,20,r),i(12,30,5,16,r),i(32,31,5,13,r),i(13,44,5,5,`#e9b58c`),i(33,42,4,6,`#e9b58c`),i(17,46,7,11,`#283947`),i(27,46,6,11,`#283947`),i(15,56,9,4,`#302d31`),i(27,55,9,4,`#302d31`),i(17,28,18,5,n?`#6bb9b4`:`#dfa552`),i(10,32,6,20,n?`#9eafb9`:`#bd6d49`),i(19,43,14,3,`#97754a`),t||(i(36,25,3,30,`#c1d5d3`),i(33,45,9,3,`#c3a26d`)),n&&(i(9,2,26,6,`#c5c5d9`),i(17,0,13,5,`#b2b5ce`),i(37,24,2,34,`#82775d`),i(34,21,8,7,`#96f7ed`))}let a=new ji(t);return a.magFilter=r,a.minFilter=r,a.colorSpace=Fe,a}let Ee=new Map;function De(e,t,n,r=2.2){Ee.has(e)||Ee.set(e,Te(e));let i=new Ur(new kr({map:Ee.get(e),color:`#fff4df`,alphaTest:.1,depthWrite:!0}));i.scale.set(r*.75,r,1),i.center.set(.5,0),i.position.set(t,Oe(t,n)+.06,n),m.add(i);let a=new di(new Ii(r*.24,24),new $r({color:`#071a20`,transparent:!0,opacity:.3,depthWrite:!1}));return a.rotation.x=-Math.PI/2,a.position.set(t,Oe(t,n)+.025,n),m.add(a),i.userData.shadow=a,i}function Oe(e,t){return k.area===1&&e>5?Math.min(2.3,(e-5)*.2):k.area===2&&t<-7?Math.min(1.5,(-t-7)*.22):0}function ke(e,t,n,r=`#ffd087`,i=8){let a=new Na(r,i,7,2);return a.position.set(e,t,n),m.add(a),a}function Ae(e,t){let n=Oe(e,t);we(e,n+.8,t,.09,1.6,I.wood);let r=document.createElement(`canvas`);r.width=r.height=32;let i=r.getContext(`2d`),a=i.createRadialGradient(16,16,0,16,16,16);a.addColorStop(0,`#fff5c6`),a.addColorStop(.23,`#ffc65b`),a.addColorStop(.5,`#ee761aaa`),a.addColorStop(1,`#ff660000`),i.fillStyle=a,i.fillRect(0,0,32,32);let o=new Ur(new kr({map:new ji(r),blending:2,depthWrite:!1}));o.position.set(e,n+1.8,t),o.scale.set(.7,1.2,1),m.add(o),x.push(o),ke(e,n+2,t)}function R(e,t,n=1){let r=Oe(e,t);we(e,r+1.6*n,t,.23*n,3.2*n,I.wood);for(let i=0;i<3;i++){let a=Ce(k.area===2?[`#234b46`,`#2c6255`,`#427b61`][i]:[`#466c49`,`#648347`,`#839455`][i]),o=new di(new Ri((2-i*.4)*n,2.5*n,7),a);o.position.set(e,r+(3+i*1.1)*n,t),o.rotation.y=Se(e+t)*5,o.castShadow=!0,o.receiveShadow=!0,m.add(o)}y.push({x:e,z:t,w:.6*n,d:.6*n})}function je(e,t,n){let r=Oe(e,t);for(let n of[-1,1]){we(e+n*2,r+1.7,t,.07,3.4,I.wood);let i=L(e+n*2.3,r+2.65,t,.55,1.1,.05,new $i({color:`#c9a257`,emissive:`#775125`,emissiveIntensity:.3}));i.rotation.z=n*.07,Ae(e+n*2,t+1)}let i=document.createElement(`canvas`);i.width=512,i.height=100;let a=i.getContext(`2d`);a.fillStyle=`#0d2631e8`,a.fillRect(0,0,512,100),a.strokeStyle=`#e6c47c`,a.lineWidth=4,a.strokeRect(3,3,506,94),a.fillStyle=`#ffe6a8`,a.font=`32px serif`,a.textAlign=`center`,a.fillText(n,256,62);let o=new Ur(new kr({map:new ji(i),depthWrite:!1}));o.position.set(e,r+3.8,t),o.scale.set(6.2,1.21,1),m.add(o);let s=new di(new Hi(1,.045,8,48),new $i({color:`#ffe1a1`,emissive:`#ffc45c`,emissiveIntensity:1.8}));s.rotation.x=-Math.PI/2,s.position.set(e,r+.12,t),m.add(s)}function Me(){if(k.quest===0||k.quest===3)return;if(k.area===0)return v.find(e=>e.id===`field`);if(k.area===1)return v.find(e=>e.id===`forest`);let e=Ol.find(e=>!k.seals.includes(e.id));return e?v.find(t=>t.id===(k.wins.includes(e.guardian)?e.id:e.guardian)):v.find(e=>e.id===(k.springUsed?`boss`:`spring`))}function Ne(e,t,n,r,i=`#467471`){L(e,1.5,t,n,3,r,I.wall),L(e,.22,t,n+.25,.45,r+.25,I.stone);for(let i of[-n/2+.1,n/2-.1])L(e+i,1.6,t+r/2+.03,.17,2.8,.15,I.wood);L(e,2.7,t+r/2+.05,n,.16,.13,I.wood);let a=Ce(i);for(let i of[-1,1]){let o=L(e+i*n*.25,3.6,t,n*.65,.23,r+.8,a);o.rotation.z=i*-.58;for(let a=0;a<5;a++){let o=L(e+i*(a+.5)*n/10,4.32-a*.18,t,.07,.08,r+.85,I.dark);o.rotation.z=i*-.58}}L(e+.6,4,t-.5,.55,1.8,.65,I.stone),L(e,1,t+r/2+.07,.85,2,.1,I.wood);for(let i of[-n*.3,n*.3])L(e+i,1.65,t+r/2+.09,.7,.9,.07,new $i({color:`#ffce81`,emissive:`#ffac45`,emissiveIntensity:2.2})),L(e+i,1.65,t+r/2+.15,.06,1,.07,I.wood),L(e+i,1.65,t+r/2+.15,.8,.06,.07,I.wood),ke(e+i,1.8,t+r/2+.5,`#ffd291`,4);y.push({x:e,z:t,w:n+.3,d:r+.3})}function z(e,t,n,r,i=e){let a={kind:e,name:t,x:n,z:r,r:2.3,id:i};return v.push(a),a}function Pe(e,t,n){let r=Oe(e,t),i=k.chests.includes(n),a=L(e,r+.35,t,.8,.6,.65,i?I.dark:I.wood);L(e,r+.63,t,.87,.13,.69,I.gold),L(e,r+.4,t+.34,.15,.25,.04,I.gold);let o=z(`chest`,i?`空の宝箱`:`宝箱を開ける`,e,t,n);o.mesh=a}function B(e,t,n,r,i=-.22){let a=new Ul(new Vi(n,r),{textureWidth:512,textureHeight:512,color:6589073,clipBias:.003});a.rotation.x=-Math.PI/2,a.position.set(e,i,t),m.add(a);let o=new di(new Vi(n,r,24,48),new $i({color:`#4e969c`,transparent:!0,opacity:.38,metalness:.7,roughness:.24}));o.rotation.x=-Math.PI/2,o.position.set(e,i+.06,t),m.add(o),b.push(o)}function V(){m.traverse(e=>{(e instanceof di||e instanceof Oi)&&(e.geometry.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{Object.values(I).includes(e)||e.dispose()})),e instanceof Ul&&e.dispose()}),o.remove(m),m=new bn,o.add(m),v=[],y=[],b=[],x=[],S=[],de=[]}function Ie(){V();let e=k.area===2;o.background=new Z(e?`#253e4d`:k.area===1?`#8fa7ac`:`#9ba9a3`),o.fog=new On(e?`#395b64`:k.area===1?`#9caeb0`:`#a0aaa3`,e?.025:.022),d.intensity=e?1.85:1.7,d.groundColor.set(e?`#63777e`:`#384538`),f.color.set(e?`#8dcde5`:`#ffcd88`),f.intensity=e?2.5:3.5,o.userData.fillLift=e?1.16:1;let t=k.area===0?-6:k.area===1?-11:21,n=k.area===0?3.3:k.area===1?5:4,r=t-n/2,i=t+n/2;if(L((-24+r)/2,-1.1,0,r+24,2,48,e?Ce(`#294942`):I.ground),L((i+24)/2,-1.1,0,24-i,2,48,e?Ce(`#294942`):I.ground),L(0,-2.8,0,49,2.1,49,I.dark),k.area===0){B(-6,0,3.3,47);for(let e of[-8,-4])L(e,.05,0,.4,.4,47,I.stone);for(let e of[5,-8]){L(-6,.1,e,5,.28,3,I.wood);for(let t=0;t<10;t++)L(-8.3+t*.5,.27,e,.07,.04,3,I.gold);for(let t of[-1.45,1.45]){L(-6,.85,e+t,4.8,.12,.13,I.wood);for(let n of[-8,-6,-4])L(n,.5,e+t,.13,1,.13,I.wood)}}y.push({x:-6,z:-17,w:3.5,d:15},{x:-6,z:-1.5,w:3.5,d:9.8},{x:-6,z:15.5,w:3.5,d:17}),L(1,.012,3,6,.04,30,I.path),L(0,.015,4,26,.04,3,I.path),Ne(-13,-2,5.5,4.7,`#405f72`),Ne(7,-4,5.8,5,`#647d6e`),Ne(13,6,4.5,4,`#806552`),Ne(-13,11,5,4,`#426e74`),Ne(6,-16,5.5,4,`#58746a`),we(0,.25,-5,2.2,.5,I.stone,16),we(0,.6,-5,1.6,.45,I.dark,16),B(0,-5,2.4,2.4,.84),we(0,1.6,-5,.25,2.5,I.stone);let e=new di(new Bi(.5),new $i({color:`#ffe1a1`,emissive:`#ffb95e`,emissiveIntensity:2}));e.position.set(0,3,-5),m.add(e),ke(0,3,-5,`#ffcf89`,12),y.push({x:0,z:-5,w:3.8,d:3.8}),De(`npc`,1,1),z(`elder`,`灯守のエダ`,1,1),De(`npc`,7,0),z(`shop`,`道具と装備の店`,7,0),De(`mage`,-12,2),z(`inn`,`宿屋「水鳥亭」`,-12,2),Pe(12,10,`town`),z(`exit`,`琥珀の丘へ`,1,-20,`field`),je(1,-20,`北門 → 琥珀の丘`),L(1,.015,-16,3.2,.06,10,I.path),Ae(-3,6),Ae(3,-10),Ae(-9,5),Ae(10,3);for(let e=0;e<22;e++){let t=Se(e+4)*43-21,n=Se(e+98)*43-21;(Math.abs(t)>16||n>16)&&R(t,n,.8+Se(e)*.35)}}else if(k.area===1){B(-11,0,5,47),y.push({x:-11,z:0,w:5,d:48});for(let e=0;e<20;e++)L(6+e*.65,-.45+e*.065,0,.7,.7+e*.13,46,I.ground);for(let e=0;e<45;e++){let t=22-e;L(Math.sin(t*.13)*2,.035,t,3.3,.06,1.1,I.path)}for(let e=0;e<38;e++){let t=Se(e+44)*42-21,n=Se(e+83)*44-22;Math.abs(t)>6&&Math.abs(t+11)>3&&R(t,n,.65+Se(e)*.7)}for(let e=0;e<12;e++){let t=10+Se(e)*10,n=Se(e+99)*30-15;L(t,Oe(t,n)+.5,n,1.5,1.4,1.6,I.stone).rotation.y=e}Pe(6,5,`field`),De(`mage`,3,13),z(`traveler`,`旅の薬師`,3,13);let e=De(`slime`,0,5,2);k.wins.includes(`slime`)?e.visible=!1:z(`enemy`,`露玉プルム`,0,5,`slime`).mesh=e;let t=De(`wolf`,-1,-7,2.3);k.wins.includes(`wolf`)?t.visible=!1:z(`enemy`,`灰羽の獣`,-1,-7,`wolf`).mesh=t,z(`exit`,`リュネの町へ`,0,21,`town`),z(`exit`,`星眠りの遺跡へ`,0,-21,`forest`),je(0,-21,`星眠りの遺跡 →`),Ae(-2,-18),Ae(2,-18)}else{B(21,0,4,47),y.push({x:21,z:0,w:4,d:48});let e=Ce(`#526561`),t=Ce(`#4e6463`),n=Ce(`#81918a`);L(0,-.02,5,33,.12,31,e);for(let e=0;e<19;e++){let t=-7-e*.7;L(0,e*.7*.11-.13,t,32,.25,1,I.stone)}for(let e of El){let r=Oe(e.x,e.z);L(e.x,r+.7,e.z,e.w,1.4,e.d,t),L(e.x,r+1.46,e.z,e.w+.12,.12,e.d+.12,n),y.push(e);let i=Math.max(e.w,e.d);for(let t=0;t<Math.floor(i/2.5);t++){let n=-i/2+(t+.5)*2.5;L(e.x+(e.w>e.d?n:0),r+.65,e.z+(e.d>e.w?n:0),e.w>e.d?.08:e.w+.03,1.2,e.d>e.w?.08:e.d+.03,I.dark)}}for(let e=0;e<12;e++)L(0,.06,18-e*2,2.4,.09,1.4,I.dark);for(let e of[-10,10])for(let t=0;t<9;t++)L(e,.07,15-t*2,1.8,.08,1.3,I.stone);for(let e=0;e<24;e++)R((e%2?-1:1)*(18.5+Se(e)*1.2),Se(e+77)*42-21,.8+Se(e)*.4);for(let e of[-3,3])we(e,2.2,-8,.5,4.4,I.stone),L(e,4.5,-8,1.4,.35,1.4,n),Ae(e,13);L(0,4.5,-8,7,.45,1.2,n);let r=kl(k.seals,k.quest);if(!r){y.push(Dl);for(let e=-2;e<=2;e++)L(e,2.05,-8,.18,3.3,.2,new $i({color:`#addaf1`,emissive:`#539ddc`,emissiveIntensity:1.2}));L(0,1.8,-8,5.5,3.4,.12,new $i({color:`#6b9fc6`,emissive:`#3e82ad`,emissiveIntensity:.4,transparent:!0,opacity:.28})),ke(0,3,-7,`#8dcaff`,15)}z(`gate`,r?`開かれた双灯の扉`:`双灯の扉（封印 ${k.seals.length}/2）`,0,-5.7,`gate`);for(let e of Ol){let t=k.seals.includes(e.id);we(e.x,.35,e.z,1.45,.7,I.stone,12);let n=new di(new Hi(1.15,.065,8,48),new $i({color:t?`#abffe1`:e.color,emissive:t?`#6cffc2`:e.color,emissiveIntensity:t?2:.7}));n.rotation.x=-Math.PI/2,n.position.set(e.x,.73,e.z),m.add(n);let r=new di(new Bi(.5),new $i({color:e.color,emissive:e.color,emissiveIntensity:t?2.5:.6}));if(r.position.set(e.x,1.65,e.z),m.add(r),ke(e.x,2,e.z,e.color,t?14:5),z(`seal`,e.name+(t?`（解放済み）`:``),e.x,e.z,e.id),!k.wins.includes(e.guardian)){let t=De(`wolf`,e.gx,e.gz,2.6);t.material.color.set(e.color),z(`enemy`,e.enemy,e.gx,e.gz,e.guardian).mesh=t}Ae(e.x,6)}L(2,.8,16,1.3,1.5,.4,I.stone),z(`tablet`,`入口の石碑`,2,16,`tablet`),Pe(-14,15,`forest`),v[v.length-1].name=k.chests.includes(`forest`)?`空の宝箱`:`西回廊の宝箱`,Pe(14,-5,`sanctum`),v[v.length-1].name=k.chests.includes(`sanctum`)?`空の宝箱`:`東の隠し宝箱`,we(2,.65,-10.5,.8,1.3,new $i({color:`#9bffe0`,emissive:`#53cfa9`,emissiveIntensity:1.4})),z(`spring`,`灯の泉`,2,-10.5,`spring`),ke(2,1,-10.5,`#9bffe0`,8);for(let e of[-4,4])for(let t of[-13,-18])we(e,Oe(e,t)+2,t,.5,4,I.stone),L(e,Oe(e,t)+4,t,1.3,.4,1.3,I.stone),Ae(e,t+1);L(0,5.1,-18,9,.6,1.1,I.stone),we(0,1.6,-16,3.6,.45,I.stone,24);let i=new di(new Hi(2,.075,8,64),new $i({color:`#8df7e1`,emissive:`#53dccc`,emissiveIntensity:3}));i.position.set(0,1.9,-16),i.rotation.x=-Math.PI/2,m.add(i),ke(0,4,-16,`#60ffe0`,22);let a=De(`boss`,0,-16,5);k.quest<3&&r?z(`boss`,`虚ろの灯守 ヴェルグ`,0,-16,`boss`).mesh=a:a.visible=!1,z(`exit`,`琥珀の丘へ`,0,21,`field`)}let a=new $i({color:e?`#4c8770`:`#a1b26b`,side:2}),c=new Vi(.1,.42);for(let t=0;t<650;t++){let n=Se(t+1e3)*44-22,r=Se(t+2e3)*44-22;if(k.area===2&&Math.abs(n)<16&&Math.abs(r)<20||Math.abs(n)<3||k.area===0&&Math.abs(n)<15&&r<15||Math.abs(n-(k.area===0?-6:k.area===1?-11:9))<3)continue;let i=new di(c,a);i.position.set(n,Oe(n,r)+.17,r),i.rotation.y=t,m.add(i),t%4==0&&S.push(i),t%8==0&&L(n,Oe(n,r)+.35,r,.09,.09,.09,new $i({color:e?`#7fdfdd`:`#ffe4ac`,emissive:e?`#53a8a8`:`#5a471c`,emissiveIntensity:e?1:.1}),!1)}let l=new Float32Array(450);for(let e=0;e<150;e++)l[e*3]=Se(e+58)*42-21,l[e*3+1]=Se(e+922)*7+.4,l[e*3+2]=Se(e+88)*42-21;let u=new Cr;u.setAttribute(`position`,new cr(l,3)),C=new Oi(u,new Ci({color:e?`#adfff0`:`#ffe0a0`,size:.065,transparent:!0,opacity:.75,blending:2,depthWrite:!1})),m.add(C),h=De(`hero`,k.x,k.z,2.2),g=De(`mage`,k.x+1,k.z+1,2.1),g.visible=k.quest>0,he.set(k.x,1,k.z),ge.set(k.x+15,21,k.z+24),s.position.copy(ge),s.lookAt(he),G()}function Le(e=!1){try{localStorage.setItem(`lumenfall-v1`,JSON.stringify({...k,version:1})),e&&ze(`冒険を記録しました`)}catch{ze(`保存できません。ブラウザの保存設定をご確認ください`)}}function Re(){try{let e=JSON.parse(localStorage.getItem(`lumenfall-v1`)||`null`);if(!e||e.version!==1||![0,1,2].includes(e.area)||!Number.isFinite(e.hp)||!Number.isFinite(e.x)||!Number.isFinite(e.z)||!Array.isArray(e.wins)||!Array.isArray(e.chests))throw Error();k={...Wl(),...e},k.seals=Array.isArray(e.seals)?e.seals.filter(e=>[`west`,`east`].includes(e)):[],k.area===2&&(e.dungeonVersion!==1||!Al(k.x,k.z,k.seals,k.quest))&&(k.x=0,k.z=18),k.dungeonVersion=1,k.x=Math.max(-21,Math.min(21,k.x)),k.z=Math.max(-21,Math.min(21,k.z)),k.hp=Math.max(1,Math.min(be(),k.hp)),w=`explore`,T=``,Ie(),ze(`記録した冒険を再開しました`)}catch{ze(`読み込める記録がありません`)}}function ze(e){ae=e,oe=P+3,G()}function Be(e,t,n){D=e,E=[...t],ee=n,T=`dialogue`,M=null,G()}function Ve(){if(T===`dialogue`){if(E.shift(),!E.length){T=``;let e=ee;ee=void 0,e?.()}G()}}function He(){k=Wl(),w=`explore`,T=``,Ie(),Be(`灯守のエダ`,[`水路の灯が、ひとつずつ消えている。森の「暁の種」が、眠ってしまったんだ。`,`リオ、灯を届けてくれるかい？ 星読みのミナが一緒に行くよ。北の道から琥珀の丘へお行き。`,`剣だけでは砕けない闇もある。ミナの星火と、癒しの光を頼るんだよ。`],()=>{k.quest=1,g.visible=!0,Le(),ze(`ミナが同行した。北の森へ向かおう`)})}function Ue(e){k.area=e,k.x=0,k.z=e===0?-17:e===1?k.z<0?18:-18:18,N=void 0,M=null,te=[],Ie(),Le(),ze(Gl[e][0]),e===2&&k.quest<3&&Be(`ミナ`,[`ここは星眠りの遺跡。奥の祭壇は、双灯の封印で閉ざされている。`,`左右の回廊を探索しよう。入口の石碑に、封印を解く手がかりがありそう。`])}function We(e=N){if(!(!e||T||w!==`explore`)){if(M=null,te=[],Ge(523,.08),e.kind===`elder`&&Be(`灯守のエダ`,k.quest===3?[`おかえり、リオ。水路に朝が戻ったね。あなたたちがつないだ灯を、私たちは守り続けるよ。`]:[`暁の種は、北の森の祭壇にある。丘の魔物で腕を磨いて、回復の準備を忘れずに。`]),e.kind===`tablet`&&Be(`入口の石碑`,[`「西には、夜を照らす静かな円。東には、朝を告げる燃える円。」`,`「二つの番獣を鎮め、正しい紋章を祠に捧げよ。双灯がともるとき、祭壇への扉は開く。」`]),e.kind===`seal`){let t=Ol.find(t=>t.id===e.id);if(k.seals.includes(e.id)){Be(t.name,[`この祠の封印は解かれている。`]);return}if(!k.wins.includes(t.guardian)){Be(`ミナ`,[t.enemy+`の気配が、祠を覆っている。先に回廊の番獣を鎮めよう。`]);return}T=`seal-`+e.id,G()}if(e.kind===`gate`&&Be(`双灯の扉`,kl(k.seals,k.quest)?[`二つの灯がともり、祭壇への道が開いている。奥の灯の泉で休んでから進もう。`]:[`扉は固く閉ざされている。左右の回廊にある二つの祠の封印を解除しよう。`,`解放した祠：`+k.seals.length+` / 2`]),e.kind===`spring`){if(k.springUsed){Be(`灯の泉`,[`泉の灯は、静かに眠っている。`]);return}k.hp=be(),k.mp=xe(),k.springUsed=!0,Le(),Be(`灯の泉`,[`あたたかな光がふたりを包んだ。HP・MPが全回復した！`])}if(e.kind===`shop`&&(T=`shop`,G()),e.kind===`inn`&&(T=`inn`,G()),e.kind===`traveler`&&Be(`旅の薬師`,[`この先は星眠りの遺跡。左右の回廊で二つの封印を解かなければ、祭壇には進めない。`,`「身を守る」でしのげば、傷は小さくなるよ。星火に弱いという噂もある。`]),e.kind===`chest`){if(k.chests.includes(e.id)){ze(`宝箱は空っぽだ`);return}k.chests.push(e.id),k.gold+=25,k.potions+=2,e.id===`forest`&&(k.ethers+=2),e.name=`空の宝箱`,Le(),Be(`宝箱`,[`25 G と 薬草 ×2 を手に入れた！`+(e.id===`forest`?` 星の雫 ×2 も入っていた。`:``)])}if(e.kind===`exit`){if(k.quest===0){Be(`ミナ`,[`出発する前に、町の灯守エダに話を聞こう。`]);return}Ue(e.id===`town`?0:e.id===`field`?1:2)}if(e.kind===`boss`&&!kl(k.seals,k.quest)){ze(`先に二つの封印を解除しよう`);return}(e.kind===`enemy`||e.kind===`boss`)&&U(e)}}function Ge(e,t=.2,n=`sine`,r=.045){if(pe||!fe)return;let i=fe.createOscillator(),a=fe.createGain();i.type=n,i.frequency.value=e,a.gain.setValueAtTime(r,fe.currentTime),a.gain.exponentialRampToValueAtTime(.001,fe.currentTime+t),i.connect(a),a.connect(fe.destination),i.start(),i.stop(fe.currentTime+t)}function Ke(){fe||=new AudioContext,fe.state===`suspended`&&fe.resume()}function qe(e,t,n,r,i=100){let a=new Float32Array(i*3),o=[];for(let r=0;r<i;r++)a[r*3]=e,a[r*3+1]=t,a[r*3+2]=n,o.push(new J((Math.random()-.5)*10,Math.random()*7,(Math.random()-.5)*10));let s=new Cr;s.setAttribute(`position`,new cr(a,3));let c=new Oi(s,new Ci({color:r,size:.12,blending:2,transparent:!0,depthWrite:!1}));c.userData={v:o,life:1.3},m.add(c),de.push(c)}function Je(e,t=!1){let n=document.createElement(`div`);n.className=`damage`,n.textContent=e,t&&(n.style.left=`30%`,n.style.color=`#acffdc`),document.getElementById(`floaters`).append(n),ye(()=>n.remove(),1100)}function H(e=!1){se=e?.42:.2,ce=.09,p.color.set(e?`#8bf5ff`:`#ffd1a0`),p.intensity=e?65:25,n.style.background=e?`#b8fff6`:`#ffe4b8`,n.style.opacity=e?`.22`:`.1`,ye(()=>n.style.opacity=`0`,110),Ge(e?880:130,.3,e?`sine`:`triangle`,.08)}function U(e){let t=e.kind===`boss`;w=`battle`,le=!0,N=void 0,F={id:e.id,boss:t,name:e.name,hp:t?245:e.id===`slime`?42:e.id.startsWith(`sentinel`)?78:60,max:t?245:e.id===`slime`?42:e.id.startsWith(`sentinel`)?78:60,turn:0,charge:!1,phase:1,origin:{x:k.x,z:k.z},obj:e},h.position.set(k.x-2,Oe(k.x,k.z),k.z+1),g.position.set(k.x-3,Oe(k.x,k.z),k.z+3),_=e.mesh,_.position.set(k.x+3,Oe(k.x,k.z),k.z-2),ue=t?`祭壇の灯が脈打つ。虚ろの灯守が目覚めた。`:`魔物が行く手をふさいだ！`,t&&(l.strength=1.1,qe(_.position.x,3,_.position.z,`#79ffee`,160),H(!0)),G(),ye(()=>{le=!1,ue=`リオたちは どうする？`,G()},1500)}function Ye(e){if(w!==`battle`||le||e===`fire`&&k.mp<6||e===`heal`&&k.mp<5||e===`potion`&&k.potions<=0||e===`ether`&&k.ethers<=0)return;le=!0;let t=_,n=0,r=!1;if(F.turn++,e===`attack`&&(n=17+k.lv*4+(k.sword?9:0),ue=`リオの攻撃！`,_e=1,ye(()=>{H(),qe(t.position.x,1.8,t.position.z,`#ffe2a0`,50)},350)),e===`fire`&&(k.mp-=6,n=33+k.lv*6+(F.boss?9:0),ue=`ミナは 星火 を唱えた！`,p.color.set(`#63cfff`),p.intensity=30,_e=2,qe(h.position.x,2,h.position.z,`#87eaff`,75),ye(()=>{H(!0),qe(t.position.x,2.5,t.position.z,`#80eaff`,160)},650)),e===`heal`){k.mp-=5;let e=Math.min(be()-k.hp,58);k.hp+=e,ue=`ミナの 灯の癒し。HPが回復した！`,qe(h.position.x,1,h.position.z,`#b1ffd4`,65),Je(`+`+e,!0),Ge(660,.7)}if(e===`potion`){k.potions--;let e=Math.min(be()-k.hp,65);k.hp+=e,ue=`薬草を使った。HPが回復した！`,Je(`+`+e,!0)}e===`ether`&&(k.ethers--,k.mp=Math.min(xe(),k.mp+20),ue=`星の雫を使った。MPが20回復した！`,Ge(740,.4)),e===`guard`&&(r=!0,ue=`リオたちは 身を守っている。`),G(),ye(()=>{n&&(F.hp=Math.max(0,F.hp-n),Je(String(n)),G())},e===`fire`?700:400),ye(()=>{if(_e=0,F.hp<=0){Ze();return}F.boss&&F.hp<=F.max*.5&&F.phase===1?(F.phase=2,o.fog=new On(`#43304f`,.037),f.color.set(`#ba91ec`),l.strength=1.35,ue=`灯守の核が露わになった。森が紫の炎に包まれる！`,H(!0),qe(t.position.x,3,t.position.z,`#d48cff`,180),G(),ye(()=>Xe(r),1300)):Xe(r)},1500)}function Xe(e){if(!F)return;if(F.boss&&!F.charge&&F.turn%3==1){F.charge=!0,ue=`ヴェルグが光を集めている… 次の一撃に備えよう！`,p.color.set(`#e5a3ff`),p.intensity=25,qe(_.position.x,2,_.position.z,`#c892ff`,70),Ge(160,.8,`triangle`),le=!1,G();return}let t=F.charge,n=F.boss?t?43:F.phase===2?23:18:F.id===`slime`?9:14;n=Math.max(1,n-(k.armor?5:0)),e&&(n=Math.ceil(n*.25)),F.charge=!1,k.hp=Math.max(0,k.hp-n),ue=(t?`ヴェルグの 月蝕の奔流！`:F.name+`の攻撃！`)+` `+n+` ダメージ`+(e?`（防御）`:``),Je(`-`+n,!0),H(t),qe(h.position.x,1.5,h.position.z,t?`#c491ff`:`#ffdba1`,t?130:40),G(),ye(()=>{k.hp<=0?(w=`explore`,F=null,T=``,k.hp=be(),k.mp=xe(),k.area=0,k.x=-10,k.z=5,k.gold=Math.max(0,k.gold-10),Ie(),Be(`宿の主人`,[`大丈夫、ここは水鳥亭。旅人が運んできてくれたんだ。`,`治療代は10 G。装備を整えて、もう一度挑んでごらん。`]),Le()):(le=!1,ue=`リオたちは どうする？`,G())},1e3)}function Ze(){let e=F.boss,t=F.id,n=e?100:t===`slime`?24:36,r=e?80:25;k.xp+=n,k.gold+=r,k.wins.includes(t)||k.wins.push(t);let i=!1;for(;k.xp>=k.lv*30;)k.xp-=k.lv*30,k.lv++,i=!0;k.hp=i?be():k.hp,k.mp=i?xe():k.mp,ue=`勝利！ `+n+` EXP / `+r+` G`+(i?`　レベルアップ！ HP・MP全回復`:``),_.visible=!1,qe(_.position.x,2,_.position.z,`#ffe2a2`,150),Ge(523,.2),ye(()=>Ge(659,.25),200),ye(()=>Ge(784,.7),400),G(),ye(()=>{w=`explore`,F=null,l.strength=.65,Ie(),e?(k.quest=3,Le(),Be(`ミナ`,[`見て。あの人は、灯を守ろうとして闇を抱え込んでいたんだね。`,`暁の種が、あたたかい。帰ろう、リオ。みんなの灯が待ってる。`],()=>{k.area=0,k.x=0,k.z=8,Ie(),f.color.set(`#ffe8bc`),f.intensity=4,o.fog=new On(`#c5c6b0`,.018),w=`ending`,Le(),G()})):(Le(),ze(i?`レベル `+k.lv+` になった！`:`道が開けた。先へ進もう`))},1900)}function Qe(){return`<div class="party"><small>Lv. ${k.lv}</small><b>リオ <span style="font-size:11px;color:#bbc9cb">& ミナ</span></b><div class="stat"><span>HP</span><div class="bar"><i style="width:${k.hp/be()*100}%"></i></div><span>${k.hp}/${be()}</span></div><div class="stat"><span>MP</span><div class="bar mp"><i style="width:${k.mp/xe()*100}%"></i></div><span>${k.mp}/${xe()}</span></div></div>`}function W(e,t,n=!1){return`<button data-action="${e}" ${n?`disabled`:``}>${t}</button>`}function G(){let e=Me(),n=`<div class="vignette"></div>`;if(w===`title`){let e=!1;try{e=!!localStorage.getItem(`lumenfall-v1`)}catch{}n+=`<div class="title"><div class="eyebrow">A TALE OF THE LAST LIGHT</div><h1>灯の継承者</h1><div class="subtitle">L U M E N F A L L</div><p>消えゆく灯。小さな約束。<br>夜明けをつなぐ、ふたりの旅。</p>${W(`new`,`はじめから　 →`)}${e?W(`load`,`つづきから`):``}</div><div class="corner">A SHORT FANTASY · 約15分の冒険</div>`}else w===`ending`?n+=`<div class="overlay"><div class="panel ending"><div class="eyebrow">THE LIGHT WILL LIVE ON</div><h1>そして、灯はつづく</h1><div class="sep"></div><p>朝の光が、水路を金色に染めた。<br>名もなき小さな勇気が、<br>今日も誰かの窓に灯をともす。</p><p>リオとミナの旅は、ここでひと休み。<br>けれど、世界にはまだ多くの夜がある。</p><div class="badge">THE END</div><p style="font-size:12px">到達レベル ${k.lv} · 討伐 ${k.wins.length} · 宝箱 ${k.chests.length}/4</p>${W(`after`,`灯の戻った町へ`)}</div></div>`:w===`battle`?n+=`<div class="battle"><div class="battlehead"><div class="eyebrow">${F.boss?`GUARDIAN OF THE HOLLOW LIGHT`:`ENCOUNTER`}</div><h2>${F.name}</h2><div class="enemybar"><i style="width:${F.hp/F.max*100}%"></i></div><p style="font:11px Arial;color:#ddd4c2">${F.hp} / ${F.max}${F.charge?`　 ⚠ 次の攻撃に備えよう`:``}</p></div><div class="bottom">${Qe()}</div><div class="battlelog">${ue}</div><div class="commands">${W(`attack`,`剣で攻撃<small>SWORD</small>`,le)}${W(`fire`,`星火<small>MP 6 · 光の攻撃</small>`,le||k.mp<6)}${W(`heal`,`灯の癒し<small>MP 5 · HP回復</small>`,le||k.mp<5)}${W(`guard`,`身を守る<small>被ダメージを軽減</small>`,le)}${W(`potion`,`薬草 ×${k.potions}<small>HP +65</small>`,le||!k.potions)}${W(`ether`,`星の雫 ×${k.ethers}<small>MP +20</small>`,le||!k.ethers)}</div></div>`:n+=`<div class="top"><div class="region"><small>${Gl[k.area][1]}</small><h2>${Gl[k.area][0]}</h2><p>${Gl[k.area][2]} · ${k.area===2?`月夜`:Math.sin(P*.015)>.6?`夕暮れ`:`午後`}</p></div><div class="tools"><button class="iconbtn" data-action="sound" aria-label="音の切り替え">${pe?`♪̸`:`♪`}</button><button class="iconbtn" data-action="map" aria-label="周辺の案内">⌖</button><button class="iconbtn" data-action="menu" aria-label="冒険メニュー">☰</button></div></div><div class="quest"><small>${k.quest===3?`旅の記憶`:`次の目的地`}</small><div class="journey"><span class="${k.area===0?`current`:``}">町</span> › <span class="${k.area===1?`current`:``}">草原</span> › <span class="${k.area===2?`current`:``}">遺跡</span> › 祭壇</div>${k.quest===0?`灯守のエダに話を聞こう`:k.quest===3?`町に灯が戻った。自由に散策しよう`:k.area===0?`北の道から、琥珀の丘へ`:k.area===1?`街道を北へ進み、星眠りの遺跡へ`:kl(k.seals,k.quest)?`双灯の扉が開いた。奥の祭壇へ`:`左右の回廊を探索し、祠の封印を解く（`+k.seals.length+`/2）`}${e?`<button class="guide" data-action="guide">${Math.hypot(e.x-k.x,e.z-k.z)<e.r?`ここから進む · `:`⌖ `}${k.area===0?`北門 → 琥珀の丘`:k.area===1?`森の入口 → 星眠りの遺跡`:e.name}${Math.hypot(e.x-k.x,e.z-k.z)<e.r?``:`まで案内`}</button>`:``}</div><div class="bottom">${Qe()}<div class="help">WASD / 矢印キー · 移動　 E / Space · 調べる<br>地面をクリック · 移動　 Esc · メニュー</div></div>${N&&!T?`<button class="interact" data-action="interact"><em>E</em>${N.name}</button>`:``}<div class="joystick" id="joystick" aria-label="移動スティック"><i></i></div>`;if(T===`dialogue`&&(n+=`<div class="dialogue"><b>${D}</b><p>${E[0]}</p>${W(`next`,E.length>1?`つづける　 ▸`:`閉じる　 ▸`)}<div style="clear:both"></div></div>`),T===`menu`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">TRAVEL JOURNAL</div><h2>冒険の記録</h2><p>リオとミナ　Lv. ${k.lv}　 /　${k.gold} G<br>経験値 ${k.xp} / ${k.lv*30}<br>武器：${k.sword?`暁鉄の剣（攻撃 +9）`:`旅立ちの剣`}<br>防具：${k.armor?`織星の外套（被ダメージ −5）`:`旅人の服`}</p>${W(`usepotion`,`薬草を使う ×${k.potions}　 HP +65`,!k.potions||k.hp===be())}${W(`useether`,`星の雫を使う ×${k.ethers}　 MP +20`,!k.ethers||k.mp===xe())}${W(`save`,`冒険を記録する`)}${W(`load`,`記録から再開する`)}${W(`controls`,`操作方法`)}${W(`close`,`旅に戻る`)}</div></div>`),T.startsWith(`seal-`)){let e=Ol.find(e=>e.id===T.slice(5));n+=`<div class="overlay"><div class="panel"><div class="eyebrow">SEAL OF THE TWIN LIGHTS</div><h2>${e.name}</h2><p>番獣の気配は消えた。<br>台座に捧げる紋章を選ぼう。<br><br>石碑の言葉：<br>「西には、夜を照らす静かな円。<br>東には、朝を告げる燃える円。」</p>${W(`glyph-moon`,`月の紋章`)}${W(`glyph-sun`,`太陽の紋章`)}${W(`glyph-star`,`星の紋章`)}${W(`close`,`あとで考える`)}</div></div>`}T===`map`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">NEARBY</div><h2>周辺の案内</h2><p>目的地を選ぶと、歩いて向かいます。</p>${v.filter(e=>(e.kind!==`chest`||!k.chests.includes(e.id))&&(e.kind!==`spring`||kl(k.seals,k.quest))).map(e=>W(`walk-`+e.id,e.name)).join(``)}${W(`close`,`戻る`)}</div></div>`),T===`shop`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">LYUNE TRADING POST</div><h2>旅支度の店</h2><p>「小さな備えが、旅を助けるよ。」<br>所持金：${k.gold} G</p>${W(`buy-potion`,`薬草　15 G　／ HP +65`,k.gold<15)}${W(`buy-ether`,`星の雫　20 G　／ MP +20`,k.gold<20)}${W(`buy-sword`,k.sword?`暁鉄の剣　装備中`:`暁鉄の剣　40 G　／ 攻撃 +9`,k.sword||k.gold<40)}${W(`buy-armor`,k.armor?`織星の外套　装備中`:`織星の外套　35 G　／ 被ダメージ −5`,k.armor||k.gold<35)}${W(`close`,`店を出る`)}</div></div>`),T===`inn`&&(n+=`<div class="overlay"><div class="panel"><div class="eyebrow">THE WATERBIRD INN</div><h2>水鳥亭</h2><p>「今夜は、窓の灯を消さずにおくよ。」<br>一泊 10 G。HP・MPをすべて回復します。<br>所持金：${k.gold} G</p>${W(`rest`,k.gold>=10?`ひと休みする　10 G`:`ひと休みする（今回は無料）`)}${W(`close`,`宿を出る`)}</div></div>`),T===`controls`&&(n+=`<div class="overlay"><div class="panel"><h2>旅の手引き</h2><p>移動：WASD / 矢印キー。地面のクリック・タップでも移動できます。スマホでは左下のスティックを使えます。<br><br>会話・宝箱・出入口：近づいて E / Space、または表示されたボタン。<br><br>戦闘はコマンド選択式。敵が力をためたら「身を守る」。HPが減ったら薬草や癒しの魔法を。<br><br>エリア移動・勝利・買い物時に自動保存。メニューから手動でも保存できます。記録はこのブラウザに保存されます。</p>${W(`close`,`戻る`)}</div></div>`),ae&&P<oe&&(n+=`<div class="toast">${ae}</div>`);let r=t.querySelector(`#joystick`);if(r&&O&&w===`explore`&&!T){let e=document.createElement(`template`);e.innerHTML=n,e.content.querySelector(`#joystick`)?.remove();for(let e of[...t.childNodes])e!==r&&e.remove();t.append(e.content)}else{O?.(),O=void 0,t.innerHTML=n;let e=t.querySelector(`#joystick`);e&&w===`explore`&&!T?O=wl(e,(e,t)=>{j={x:e,y:t},M=null,te=[]}):j={x:0,y:0}}}function $e(e){let t=e.target.closest(`[data-action]`);if(!t||t.disabled)return;Ke();let n=t.dataset.action;if(w===`battle`){Ye(n);return}if(Ge(440,.04),n.startsWith(`glyph-`)&&T.startsWith(`seal-`)){let e=Ol.find(e=>e.id===T.slice(5));if(n.slice(6)!==e.answer){ze(`紋章が淡く揺れた。石碑の言葉を思い出そう。`);return}k.seals.push(e.id),T=``,Ie(),Le(),qe(e.x,2,e.z,e.color,100),Be(`ミナ`,kl(k.seals,k.quest)?[`二つの灯がつながった！ 双灯の扉が開いたよ。`,`奥に回復の泉がある。準備を整えて、祭壇へ進もう。`]:[e.name+`の封印が解けた。もう一方の回廊へ行こう。`]),G();return}if(n===`guide`){let e=Me();e&&(Math.hypot(e.x-k.x,e.z-k.z)<e.r?We(e):(ot(e.x,e.z),ze(`目的地まで歩いて案内します`)))}if(n===`new`&&He(),n===`load`&&Re(),n===`next`&&Ve(),n===`interact`&&We(),n===`menu`&&(T=T?``:`menu`,M=null),n===`close`&&(T=``),n===`controls`&&(T=`controls`),n===`map`&&(T=`map`),n.startsWith(`walk-`)){let e=v.find(e=>e.id===n.slice(5));T=``,e&&ot(e.x,e.z)}if(n===`sound`&&(pe=!pe),n===`save`&&Le(!0),n===`after`&&(w=`explore`,T=``,Le()),n===`usepotion`&&k.potions&&(k.potions--,k.hp=Math.min(be(),k.hp+65),Le()),n===`useether`&&k.ethers&&(k.ethers--,k.mp=Math.min(xe(),k.mp+20),Le()),n.startsWith(`buy-`)){let e=n.slice(4),t=e===`potion`?15:e===`ether`?20:e===`sword`?40:35;k.gold>=t&&(k.gold-=t,e===`potion`&&k.potions++,e===`ether`&&k.ethers++,e===`sword`&&(k.sword=!0),e===`armor`&&(k.armor=!0),Le(),ze(e===`sword`||e===`armor`?`購入して装備した`:`購入した`))}n===`rest`&&(k.gold=Math.max(0,k.gold-10),k.hp=be(),k.mp=xe(),T=``,Le(),Be(`宿の主人`,[`ゆっくり休めたかい？ HP・MPが全回復したよ。いってらっしゃい。`])),G()}t.addEventListener(`click`,$e);let et=e=>{[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,` `,`Tab`].includes(e.key)&&e.key!==`Tab`&&e.preventDefault(),A.add(e.key.toLowerCase()),!e.repeat&&(Ke(),e.key===`Escape`&&w===`explore`&&(T===`dialogue`?Ve():(T=T?``:`menu`,G())),[`e`,`E`,` `,`Enter`].includes(e.key)&&(T===`dialogue`?Ve():w===`explore`&&!T&&We()))},tt=e=>A.delete(e.key.toLowerCase()),K=()=>{A.clear(),j={x:0,y:0},M=null,te=[]};window.addEventListener(`keydown`,et),window.addEventListener(`keyup`,tt),window.addEventListener(`blur`,K);let nt=new no,rt=new vi(new J(0,1,0),0),it=e=>{if(w!==`explore`||T)return;let t=new q(e.clientX/innerWidth*2-1,-e.clientY/innerHeight*2+1);nt.setFromCamera(t,s);let n=new J;nt.ray.intersectPlane(rt,n)&&ot(St.clamp(n.x,-21,21),St.clamp(n.z,-21,21))};e.addEventListener(`pointerdown`,it);function at(){i.setSize(innerWidth,innerHeight),c.setSize(innerWidth,innerHeight),s.aspect=innerWidth/innerHeight,s.updateProjectionMatrix(),u.uniforms.resolution.value.set(innerWidth*i.getPixelRatio(),innerHeight*i.getPixelRatio())}window.addEventListener(`resize`,at),at(),Ie(),document.getElementById(`loading`)?.remove();function ot(e,t){let n=.75,r=[Math.round(k.x/n),Math.round(k.z/n)],i=[r],a=new Set([r.join(`,`)]),o=new Map,s=``;for(let r=0;r<i.length&&r<5e3;r++){let[c,l]=i[r];if(Math.hypot(c*n-e,l*n-t)<1.2){s=[c,l].join(`,`);break}for(let[e,t]of[[0,1],[0,-1],[1,0],[-1,0]]){let r=c+e,s=l+t,u=[r,s].join(`,`);!a.has(u)&&st(r*n,s*n)&&(a.add(u),o.set(u,[c,l].join(`,`)),i.push([r,s]))}}if(s){let e=[];for(;o.has(s);){let[t,r]=s.split(`,`).map(Number);e.push(new J(t*n,0,r*n)),s=o.get(s)}te=e.reverse(),M=te.shift()??null}else ze(`そこへは歩いて行けないようだ`)}function st(e,t){return e>-22&&e<22&&t>-22&&t<22&&(k.area!==2||Al(e,t,k.seals,k.quest))&&!y.some(n=>Math.abs(e-n.x)<n.w/2+.23&&Math.abs(t-n.z)<n.d/2+.23)}function ct(e){if(ie)return;re=a?window.setTimeout(()=>ct(performance.now()),33):requestAnimationFrame(ct);let t=Math.min((e-ne)/1e3,.045);if(ne=e,P+=t,k.time+=t,se*=.88,ce=Math.max(0,ce-t),p.intensity*=.93,ae&&P>oe&&(ae=``,G()),fe&&!pe&&P>me){me=P+(w===`battle`?.4:1.1);let e=w===`battle`?[146.83,220,293.66,349.23,440]:k.area===2?[196,293.66,392,440,587.33]:[220,329.63,440,493.88,659.25];Ge(e[Math.floor(P*1.1)%e.length],1.8,`sine`,.016)}let n=C.geometry.attributes.position;for(let e=0;e<n.count;e++)n.setY(e,n.getY(e)+t*.13),n.setX(e,n.getX(e)+Math.sin(P*.3+e)*t*.04),n.getY(e)>8&&n.setY(e,.3);n.needsUpdate=!0;for(let e of x)e.scale.y=1.05+Math.sin(P*13+e.position.x)*.18,e.position.x+=Math.sin(P*10+e.position.z)*9e-4;for(let e of S)e.rotation.z=Math.sin(P*2+e.position.x)*.12;for(let e of b){let t=e.geometry.attributes.position;for(let e=0;e<t.count;e++)t.setZ(e,Math.sin(t.getX(e)*3+P*1.6+t.getY(e))*.025);t.needsUpdate=!0,e.geometry.computeVertexNormals()}for(let e of[...de]){e.userData.life-=t;let n=e.geometry.attributes.position;for(let r=0;r<n.count;r++){let i=e.userData.v[r];n.setXYZ(r,n.getX(r)+i.x*t,n.getY(r)+i.y*t,n.getZ(r)+i.z*t),i.y-=t*5}n.needsUpdate=!0,e.material.opacity=Math.max(0,e.userData.life/1.3),e.userData.life<=0&&(m.remove(e),e.geometry.dispose(),e.material.dispose(),de.splice(de.indexOf(e),1))}if(w===`explore`&&!T){let e=0,n=0,r=(A.has(`d`)||A.has(`arrowright`)?1:0)-(A.has(`a`)||A.has(`arrowleft`)?1:0)+j.x,i=(A.has(`s`)||A.has(`arrowdown`)?1:0)-(A.has(`w`)||A.has(`arrowup`)?1:0)+j.y;r||i?(M=null,te=[],e=r*.85+i*.53,n=-r*.53+i*.85):M&&(e=M.x-k.x,n=M.z-k.z,Math.hypot(e,n)<.18&&(M=te.shift()??null,e=n=0));let a=Math.hypot(e,n);if(a>.01){e/=a,n/=a;let r=k.x+e*t*5,i=k.z+n*t*5,o=!1;st(r,k.z)&&(k.x=r,o=!0),st(k.x,i)&&(k.z=i,o=!0),o||(M=null),h.material.rotation=Math.sin(P*15)*.035,h.position.y=Oe(k.x,k.z)+Math.abs(Math.sin(P*12))*.07,h.material.map.repeat.x=1,h.material.map.offset.x=0}else h.material.rotation=0,h.position.y=Oe(k.x,k.z)+.06;h.position.x=k.x,h.position.z=k.z;let o=v.filter(e=>Math.hypot(e.x-k.x,e.z-k.z)<e.r).sort((e,t)=>Math.hypot(e.x-k.x,e.z-k.z)-Math.hypot(t.x-k.x,t.z-k.z))[0];o!==N&&(N=o,G())}if(w!==`battle`){if(g.position.lerp(new J(k.x+1,Oe(k.x+1,k.z+1)+.06,k.z+1),t*4),w===`title`)he.set(-1,1,0),ge.set(22+Math.sin(P*.05)*3,24,31);else{he.set(k.x,1,k.z-1);let e=innerWidth<600;ge.set(k.x+(e?19:15),e?27:21,k.z+(e?30:24))}if(k.area!==2){let e=.5+.5*Math.sin(P*.015);f.color.setHSL(.105-e*.045,.52,.8),f.intensity=3.8-e*1.3,f.position.x=-18+Math.sin(P*.012)*10}}else{let e=h.position,t=_.position,n=innerWidth<600,r=P*(F.boss?.24:.12);he.set((e.x+t.x)/2,1.5,(e.z+t.z)/2);let i=n?F.boss?35:29:17;ge.set(he.x+Math.sin(r)*3+6,_e===2?9:12,he.z+i-(_e?3:0)),F.boss&&(_.position.y=Oe(k.x,k.z)+Math.sin(P*2)*.15,_.material.color.set(F.phase===2?`#e0bdff`:`#d7fffa`))}s.position.lerp(ge,t*(w===`battle`?2.3:3));let r=new J;r.copy(he),se&&(s.position.x+=(Math.random()-.5)*se,s.position.y+=(Math.random()-.5)*se),s.lookAt(r);for(let e of[h,g])e.userData.shadow.position.set(e.position.x,Oe(e.position.x,e.position.z)+.025,e.position.z);ce<=0&&c.render()}return re=a?window.setTimeout(()=>ct(performance.now()),33):requestAnimationFrame(ct),()=>{ie=!0,O?.(),cancelAnimationFrame(re),clearTimeout(re),ve.forEach(clearTimeout),window.removeEventListener(`keydown`,et),window.removeEventListener(`keyup`,tt),window.removeEventListener(`blur`,K),window.removeEventListener(`resize`,at),e.removeEventListener(`pointerdown`,it),t.removeEventListener(`click`,$e),fe?.close(),V(),Ee.forEach(e=>e.dispose()),c.dispose(),i.dispose()}}Kl();